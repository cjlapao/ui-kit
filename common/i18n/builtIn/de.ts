...
export const DE_KIT_CATALOG: MessageCatalog = {
  kit: {
    ...
    gantt: {
      ...
      resize: "Aufgabe skalieren",
      link: "Abh\u00e4ngigkeit erstellen",
      progress: "Fortschritt anpassen",
      duration: "Dauer",
      task: "Aufgabe",
      dragReorder: "Ziehen zum Umsortieren",
      resizeStart: "Beginn skalieren",
      resizeEnd: "Ende skalieren",
      removeDependency: "Diese Abh\u00e4ngigkeit entfernen (oder Entf dr\u00fccken)",
      linkFromStart: "Abh\u00e4ngigkeit ab Beginn von {task} erstellen",
      linkFromEnd: "Abh\u00e4ngigkeit ab Ende von {task} erstellen",
      collapse: "{name} reduzieren",
      ...
      delete: "L\u00f6schen",
      barAria: "{task}: {start} bis {end}, {duration}, {pct} % abgeschlossen",
      barAriaMilestone: "{task}: {start} bis {end}, Meilenstein",
      zoomQuarter: "Quartal",
    },
    help: {
      show: "Hilfe anzeigen",
