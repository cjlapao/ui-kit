...
export const PT_KIT_CATALOG: MessageCatalog = {
  kit: {
    ...
    gantt: {
      ...
      empty: "Nenhuma tarefa para exibir",
      today: "Hoje",
      select: "Selecionar tarefa",
      move: "Mover tarefa",
      resize: "Redimensionar tarefa",
      link: "Criar depend\u00eancia",
      progress: "Ajustar progresso",
      duration: "Dura\u00e7\u00e3o",
      task: "Tarefa",
      dragReorder: "Arraste para reordenar",
      resizeStart: "Redimensionar in\u00edcio",
      resizeEnd: "Redimensionar fim",
      removeDependency: "Remover esta depend\u00eancia (ou pressione Delete)",
      linkFromStart: "Criar depend\u00eancia do in\u00edcio de {task}",
      linkFromEnd: "Criar depend\u00eancia do fim de {task}",
      ...
      delete: "Excluir",
      barAria: "{task}: de {start} a {end}, {duration}, {pct}% conclu\u00edda",
      barAriaMilestone: "{task}: de {start} a {end}, marco",
