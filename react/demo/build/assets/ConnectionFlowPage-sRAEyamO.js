import{r as s,j as e,bb as o,av as K,bc as Q,f as J,ay as X}from"./index-8i9ZNynb.js";import{P as ee}from"./PageHeader-CO5k_SQv.js";import{E as a}from"./ExampleCard-LdxcpmX_.js";import{P as te,S as i,C as ne,T as l}from"./PlaygroundPanel-Dv9BQ1Hr.js";import{C as se}from"./ControlAccordion-Bqp-1oBj.js";import{n as ie,t as oe,aP as ae,p as le,aQ as re,aR as de,aS as ce,aT as ue,aU as pe,aV as he,aW as ge}from"./options-yAU-f7tt.js";const d=[{id:"release",title:"Release Canary version",subtitle:"10s",icon:"Rocket",status:"succeeded",progress:1},{id:"matrix-mac",group:"build",title:"Matrix: Release Go Binary (macOS)",subtitle:"2 jobs completed",icon:"Apple",status:"succeeded",kind:"parallel",items:[{id:"mac-arm",title:"darwin/arm64",subtitle:"1m 20s",status:"succeeded"},{id:"mac-x64",title:"darwin/amd64",subtitle:"1m 44s",status:"succeeded"},{id:"mac-uni",title:"darwin/universal",subtitle:"58s",status:"succeeded"},{id:"mac-sign",title:"codesign",subtitle:"12s",status:"succeeded"},{id:"mac-notary",title:"notarize",subtitle:"queued",status:"pending"}]},{id:"matrix-win",group:"build",title:"Matrix: Release Go Binary (Windows)",subtitle:"6 jobs completed",icon:"Windows",status:"succeeded",kind:"parallel",itemProgress:"spinner",items:[{id:"win-x64",title:"windows/amd64",subtitle:"signing",progress:.62,status:"running"},{id:"win-arm",title:"windows/arm64",subtitle:"3m 02s",progress:1,status:"succeeded"}]},{id:"docker",group:"build",title:"Build Docker Images",subtitle:"13m 13s",icon:"Docker",status:"running",kind:"parallel",items:[{id:"dk-amd",title:"linux/amd64",subtitle:"pushing",progress:.8},{id:"dk-arm",title:"linux/arm64",subtitle:"pushing",progress:.35}]},{id:"staging",group:"publish",title:"Deploy to Staging",subtitle:"eu-west-1 · 4s",icon:"Host",status:"running",kind:"parallel",progress:.55,connector:{label:"on: main"}},{id:"announce",group:"publish",title:"Announce on Discord",icon:"Notification",status:"succeeded",kind:"parallel",maxHeight:120,items:[{id:"an-1",title:"#releases",subtitle:"posted",status:"succeeded"},{id:"an-2",title:"#engineering",subtitle:"posted",status:"succeeded"},{id:"an-3",title:"#support",subtitle:"posted",status:"succeeded"},{id:"an-4",title:"#changelog",subtitle:"posted",status:"succeeded"}],maxItems:0},{id:"scan",title:"Security Scan",subtitle:"govulncheck",icon:"Key",status:"skipped"},{id:"cleanup",title:"Remove old canary release",subtitle:"waiting",icon:"Trash",status:"pending",connector:{state:"disabled"}}],me=()=>{const[n,r]=s.useState("md"),[c,E]=s.useState("neutral"),[u,I]=s.useState("rounded-md"),[p,P]=s.useState("outlined"),[h,L]=s.useState("orthogonal"),[g,A]=s.useState("md"),[m,D]=s.useState("flowing"),[f,_]=s.useState("bar"),[b,R]=s.useState("bar"),[x,z]=s.useState(2),[w,W]=s.useState("skeleton"),[v,H]=s.useState(!1),[y,V]=s.useState(!0),[S,G]=s.useState(120),[C,B]=s.useState(700),[k,q]=s.useState(!0),[N,M]=s.useState(!0),[j,U]=s.useState(!0),[O,Z]=s.useState(!0),[T,$]=s.useState(!0),[F,Y]=s.useState(null);return e.jsx(te,{controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(se,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(i,{label:"Size",options:ie,value:n,onChange:t=>r(t)}),e.jsx(i,{label:"Tone",options:oe,value:c,onChange:t=>E(t)}),e.jsx(i,{label:"Variant",options:ae,value:p,onChange:t=>P(t)}),e.jsx(i,{label:"Corner",options:le,value:u,onChange:t=>I(t)})]})},{id:"states",title:"States",controls:e.jsxs(e.Fragment,{children:[e.jsx(i,{label:"Loader",options:re,value:w,onChange:t=>W(t)}),e.jsx(i,{label:"Flow state",options:de,value:m,onChange:t=>D(t)}),e.jsx(ne,{label:"Behaviour",children:e.jsxs("div",{className:"space-y-1.5",children:[e.jsx(l,{label:"Loading",checked:v,onChange:H}),e.jsx(l,{label:"Header",checked:y,onChange:V}),e.jsx(l,{label:"Auto state",checked:k,onChange:q}),e.jsx(l,{label:"Animated",checked:N,onChange:M}),e.jsx(l,{label:"Highlight path",checked:j,onChange:U}),e.jsx(l,{label:"Zoom controls",checked:O,onChange:Z}),e.jsx(l,{label:"Zoom / pan",checked:T,onChange:$})]})})]})},{id:"content",title:"Content",controls:e.jsxs(e.Fragment,{children:[e.jsx(i,{label:"Edge style",options:ce,value:h,onChange:t=>L(t)}),e.jsx(i,{label:"Ring size",options:ue,value:g,onChange:t=>A(t)}),e.jsx(i,{label:"Progress",options:pe,value:f,onChange:t=>_(t)}),e.jsx(i,{label:"Item progress",options:he,value:b,onChange:t=>R(t)}),e.jsx(i,{label:"Rows before “show more”",options:ge,value:String(x),onChange:t=>z(Number(t))})]})},{id:"motion",title:"Motion",controls:e.jsxs(e.Fragment,{children:[e.jsx(i,{label:"Dot speed",options:[{label:"60 px/s",value:"60"},{label:"120 px/s",value:"120"},{label:"180 px/s",value:"180"},{label:"240 px/s",value:"240"},{label:"360 px/s",value:"360"},{label:"480 px/s",value:"480"}],value:String(S),onChange:t=>G(Number(t))}),e.jsx(i,{label:"Dot interval",options:[{label:"250 ms",value:"250"},{label:"450 ms",value:"450"},{label:"700 ms",value:"700"},{label:"1200 ms",value:"1200"}],value:String(C),onChange:t=>B(Number(t))})]})}]}),e.jsxs("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:["Every edge — track, fan, child and bypass alike — is routed by one port-and-shape engine, so ",e.jsx("strong",{children:"edge style"})," applies to all of them at once. Scroll to zoom, drag to pan, and hover a node to light the path that reached it. ",e.jsx("strong",{children:"Variant"})," is one decision, not two: the cards take the surface of the panel they sit in rather than a scale of their own. Every dot moves at one"," ",e.jsx("strong",{children:"speed"}),", and each source releases one at a time — first target, second, third, then round again — so a fan reads as one source feeding its targets rather than as a swarm. The matrix cards are built from"," ",e.jsx("strong",{children:"items"}),": one runs past the cap so the rest fold behind “show more”, one shows a spinner in place of its glyph until it finishes, and “Announce on Discord” is capped with"," ",e.jsx("code",{children:"maxHeight"})," so its body scrolls."]})]}),preview:e.jsxs("div",{className:"w-full space-y-2",children:[e.jsx(o,{nodes:d,variant:p,eyebrow:"release_canary.yml",title:"Release Canary version",subtitle:"on: workflow_dispatch",icon:"Rocket",tag:"LIVE",tagTone:"emerald",showHeader:y,loading:v,loaderType:w,size:n,tone:c,corner:u,edgeStyle:h,ringSize:g,flowState:m,progressType:f,itemProgress:b,dotSpeed:S,dotInterval:C,maxVisibleItems:x,autoState:k,animated:N,highlightPath:j,showControls:O,interactive:T,height:520,onNodeClick:t=>Y(t.id)}),e.jsx("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:F?`Selected: ${F}`:"Click a node to select it."})]})})};function fe(){return e.jsx("div",{className:"grid w-full gap-4",children:K.map(n=>e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"text-[11px] font-semibold uppercase tracking-wide opacity-60",children:n}),e.jsx(o,{fitOnLoad:!0,nodes:d,edgeStyle:n,variant:"outlined",autoState:!0,height:260})]},n))})}const be=`import { CONNECTION_FLOW_EDGE_STYLES, ConnectionFlow } from "@cjlapao/ui-kit";
...
`,ke=[{id:"a",title:"Build",subtitle:"13m 13s",icon:"Docker",tone:"emerald"},{id:"b",title:"Deploy",subtitle:"eu-west-1",icon:"Host",tone:"blue"},{id:"c",title:"Announce",subtitle:"waiting",icon:"Notification"}];function Ne(){return e.jsx("div",{className:"grid w-full gap-4 sm:grid-cols-2",children:J.map(n=>e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"text-[11px] font-semibold uppercase tracking-wide opacity-60",children:n}),e.jsx(o,{fitOnLoad:!0,nodes:ke,variant:n,title:n,size:"sm",progressType:"none",showControls:!1,height:150})]},n))})}const je=`import { SURFACE_VARIANTS, ConnectionFlow } from "@cjlapao/ui-kit";
import type { ConnectionFlowNode } from "@cjlapao/ui-kit";
...
`,Oe=[{id:"listen",title:"LISTENING",subtitle:"0.0.0.0:40900",icon:"Globe",tone:"sky",active:!0},{id:"target",title:"TARGET",subtitle:"6c6620…",icon:"Host"}];function Te(){return e.jsx("div",{className:"grid w-full gap-4 sm:grid-cols-3",children:X.filter(n=>["fit","sm","xl"].includes(n)).map(n=>e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"text-[11px] font-semibold uppercase tracking-wide opacity-60",children:n}),e.jsx(o,{fitOnLoad:!0,nodes:Oe,ringSize:n,size:"sm",progressType:"none",showControls:!1,height:160})]},n))})}const Fe=`import { CONNECTION_FLOW_RING_SIZES, ConnectionFlow } from "@cjlapao/ui-kit";
import type { ConnectionFlowNode } from "@cjlapao/ui-kit";
...
`;function Le(){return e.jsx(o,{fitOnLoad:!0,nodes:d,autoState:!0,highlightPath:!0,height:280,variant:"outlined"})}const Ae=`import { ConnectionFlow } from "@cjlapao/ui-kit";
import { CI_FLOW } from "./sampleFlow";
...
`,ze=[{id:"a",title:"Lint",tone:"emerald"},{id:"b",title:"Integration tests",tone:"neutral"},{id:"c",title:"Publish",tone:"emerald"}];function We(){return e.jsx(o,{fitOnLoad:!0,nodes:ze,autoState:!0,variant:"outlined",height:200})}const He=`import { ConnectionFlow } from "@cjlapao/ui-kit";
import type { ConnectionFlowNode } from "@cjlapao/ui-kit";
