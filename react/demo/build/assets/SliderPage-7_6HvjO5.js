...
`,Z="mb-2 text-sm font-medium text-neutral-900 dark:text-neutral-100",J={solid:"Solid",soft:"Soft",outline:"Outline",ghost:"Ghost",glass:"Glass"};function K(){return e.jsx("div",{className:"grid w-full max-w-2xl grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2",children:T.map(n=>e.jsxs("div",{children:[e.jsx("h4",{className:Z,children:J[n]??n}),e.jsx(l,{variant:n,defaultValue:50})]},n))})}const Q=`import { Slider, SLIDER_VARIANTS } from "@cjlapao/ui-kit";
