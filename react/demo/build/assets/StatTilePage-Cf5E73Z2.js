import{r as a,j as e,bb as h,bd as k,bu as R,bv as A,bw as b,be as m,bx as W,by as O}from"./index-p9Bv1Pn1.js";import{P as V}from"./PageHeader-DCZtzAyX.js";import{E as w}from"./ExampleCard-BS13YSEO.js";import{P as I,a as d,C as u,T as r}from"./PlaygroundPanel-BDClNSzf.js";import{C as Q}from"./ControlAccordion-CydkdljU.js";import{u as K}from"./StatBaseControls-BU0O4FLV.js";import{a$ as X}from"./options-Bqu3_N-h.js";const Y=[{label:"Card",value:"card"},{label:"Tile",value:"tile"},{label:"Count",value:"count"},{label:"Goal",value:"goal"},{label:"Chart",value:"chart"},{label:"Graph",value:"graph"},{label:"Health",value:"health"}],$={card:"The base. Everything else on this page is this component with a body.",tile:"StatCard under the older prop names — `title`, `color`, `textColor`, a `progress` object. Nothing of its own.",count:"Adds `breakdown`: labelled rows under the count. Defaults `size` to `xl`.",goal:"Adds `goals` and `ringSize`. Rings scale with the card's `size`.",chart:"Adds `data` and `chartSize`: a navigable donut with a legend.",graph:"Adds `data`, `series` and `chartType`. `variant` is the Panel surface again — it used to be the chart kind.",health:"Adds `state`, `bpm` and `height`: a live ECG trace as the body."},J=[{value:78,label:"Uptime target",icon:"HealthCheck"},{value:45,label:"Cost budget",icon:"Shop"},{value:92,label:"Coverage",icon:"Rocket"}],f=[{id:"regions",label:"By region",centerLabel:"capsules",items:[{label:"us-east",value:48},{label:"eu-west",value:31},{label:"ap-south",value:22},{label:"sa-east",value:9}]},{id:"tiers",label:"By tier",centerLabel:"capsules",items:[{label:"Standard",value:71},{label:"Premium",value:27},{label:"Trial",value:12}]}],Z=[{name:"Mon",requests:42,errors:4},{name:"Tue",requests:58,errors:7},{name:"Wed",requests:51,errors:3},{name:"Thu",requests:73,errors:9},{name:"Fri",requests:66,errors:5}],ee=[{key:"requests",label:"Requests"},{key:"errors",label:"Errors"}],ae=[{label:"Running",value:96},{label:"Paused",value:24},{label:"Failed",value:8,color:"rose"}],te=()=>{const{groups:G,statProps:n}=K(),[s,P]=a.useState("card"),[p,q]=a.useState(!0),[c,E]=a.useState(""),[g,H]=a.useState(!0),[v,N]=a.useState("bar"),[x,z]=a.useState(!0),[S,F]=a.useState(!0),[C,L]=a.useState(!0),[y,B]=a.useState(!0),[T,D]=a.useState("healthy"),[j,U]=a.useState("60"),l="Active capsules",i=128,_=(()=>{switch(s){case"count":return e.jsx(u,{label:"Count extras",children:e.jsx(r,{label:"Breakdown rows",checked:p,onChange:q})});case"goal":return e.jsx(d,{label:"Ring size",options:[{label:"(from size)",value:""},{label:"40",value:"40"},{label:"64",value:"64"},{label:"88",value:"88"}],value:c,onChange:E});case"chart":return e.jsx(u,{label:"Chart extras",children:e.jsx(r,{label:"Two datasets",checked:g,onChange:H})});case"graph":return e.jsxs(e.Fragment,{children:[e.jsx(d,{label:"Chart type",options:O.map(t=>({label:t,value:t})),value:v,onChange:t=>N(t)}),e.jsx(u,{label:"Graph extras",children:e.jsxs("div",{className:"space-y-1.5",children:[e.jsx(r,{label:"Axes",checked:x,onChange:z}),e.jsx(r,{label:"Grid",checked:S,onChange:F}),e.jsx(r,{label:"Legend",checked:C,onChange:L}),e.jsx(r,{label:"Animate",checked:y,onChange:B})]})})]});case"health":return e.jsxs(e.Fragment,{children:[e.jsx(d,{label:"Health state",options:X,value:T,onChange:t=>D(t)}),e.jsx(d,{label:"BPM",options:[{label:"48",value:"48"},{label:"60",value:"60"},{label:"96",value:"96"},{label:"128",value:"128"}],value:j,onChange:U})]});default:return null}})(),M=(()=>{switch(s){case"tile":return e.jsx(W,{...n,title:l,value:i});case"count":return e.jsx(m,{...n,label:l,value:i,breakdown:p?ae:void 0});case"goal":return e.jsx(b,{...n,label:l,goals:J,ringSize:c?Number(c):void 0});case"chart":return e.jsx(A,{...n,label:l,data:g?f:f.slice(0,1)});case"graph":return e.jsx(R,{...n,label:l,value:i,data:Z,series:ee,chartType:v,showAxes:x,showGrid:S,showLegend:C,chartAnimation:y});case"health":return e.jsx(k,{...n,label:l,value:i,state:T,bpm:Number(j)});default:return e.jsx(h,{...n,label:l,value:i})}})();return e.jsx(I,{controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(Q,{groups:[{id:"variant",title:"Variant",controls:e.jsxs(e.Fragment,{children:[e.jsx(d,{label:"Stat variant",options:Y.map(t=>({...t})),value:s,onChange:t=>P(t)}),_]})},...G]}),e.jsxs("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:[$[s]," Every control below ",e.jsx("strong",{children:"Stat variant"})," ","is a ",e.jsx("code",{children:"StatCard"})," prop and applies to all seven — they are the same hook the Stat Card page uses, so the two lists cannot drift."]})]}),preview:e.jsx("div",{className:s==="chart"||s==="graph"?"w-full max-w-md":"w-full max-w-xs",children:M})})},o={variant:"elevated",size:"md",corner:"rounded-lg"};function ne(){return e.jsxs("div",{className:"grid w-full gap-4 sm:grid-cols-2",children:[e.jsx(h,{...o,label:"Active capsules",value:128,icon:"Rocket",tone:"blue",trend:{value:"+12%",direction:"up"}}),e.jsx(m,{...o,label:"Total",value:412,tone:"violet",icon:"Database",breakdown:[{label:"Running",value:128,color:"emerald"},{label:"Stopped",value:284,color:"rose"}]}),e.jsx(b,{...o,label:"Goals",tone:"emerald",goals:[{value:72,label:"Uptime",icon:"HealthCheck"},{value:45,label:"Coverage",icon:"Check"}]}),e.jsx(A,{...o,label:"Distribution",tone:"amber",data:[{id:1,label:"By state",centerLabel:"capsules",items:[{label:"Running",value:12},{label:"Paused",value:5},{label:"Failed",value:3}]}]}),e.jsx(R,{...o,label:"Throughput",value:"66/s",tone:"cyan",chartType:"bar",series:[{key:"requests",label:"Requests"}],data:[{name:"Mon",requests:42},{name:"Tue",requests:58},{name:"Wed",requests:51},{name:"Thu",requests:73},{name:"Fri",requests:66}]}),e.jsx(k,{...o,label:"Service health",value:"99.98%",tone:"rose",icon:"HealthCheck",state:"healthy",bpm:72})]})}const le=`import {
  StatCard,
  StatChartTile,
  StatCountTile,
  StatGoalTile,
