import{r as t,j as e,bi as s,bj as g,o as f}from"./index-BBK6HA-D.js";import{P as j}from"./PageHeader-BcBcU29I.js";import{E as d}from"./ExampleCard-BVwGIEPO.js";import{P as b,C as w,S as l,a as A,T as p}from"./ControlAccordion-DallGojj.js";import{n as k,t as z}from"./options-D-FMIizr.js";const S=g.map(a=>({label:a,value:a})),N=()=>{const[a,x]=t.useState("md"),[r,m]=t.useState("neutral"),[i,h]=t.useState("circle"),[o,u]=t.useState(!0),[c,v]=t.useState(!1);return e.jsx(b,{controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(w,{groups:[{id:"options",title:"Options",controls:e.jsxs(e.Fragment,{children:[e.jsx(l,{label:"Size",options:k,value:a,onChange:n=>x(n)}),e.jsx(l,{label:"Tone",options:z,value:r,onChange:n=>m(n)}),e.jsx(l,{label:"Shape",options:S,value:i,onChange:n=>h(n)}),e.jsx(A,{label:"User",children:e.jsxs("div",{className:"space-y-1.5",children:[e.jsx(p,{label:"Has a name",checked:o,onChange:u}),e.jsx(p,{label:"Has an image (broken URL)",checked:c,onChange:v})]})})]})}]}),e.jsxs("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:["Turn the image on to see the fallback: the URL is deliberately broken, so it fails and drops back to the initial. The avatar is"," ",e.jsx("code",{children:'role="img"'})," with a name in every branch — it used to be an unlabelled ",e.jsx("code",{children:"div"})," whose only ",e.jsx("code",{children:"alt"})," was on the happy path."]})]}),preview:e.jsx(s,{size:a,tone:r,shape:i,user:{name:o?"Ada Lovelace":void 0,avatarUrl:c?"https://example.invalid/missing.png":void 0}})})};function y(){return e.jsxs("div",{className:"flex flex-wrap items-end gap-4",children:[f.map(a=>e.jsxs("div",{className:"flex flex-col items-center gap-1",children:[e.jsx(s,{size:a,user:{name:"Ada"}}),e.jsx("span",{className:"text-[11px] opacity-60",children:a})]},a)),e.jsxs("div",{className:"flex flex-col items-center gap-1",children:[e.jsx(s,{size:72,user:{name:"Ada"}}),e.jsx("span",{className:"text-[11px] opacity-60",children:"72px"})]})]})}const U=`import { CONTROL_SIZES, UserAvatar } from "@cjlapao/ui-kit";
