import{r as l,aT as k,j as e,aU as i,M as E,I as v,e as d}from"./index-BBK6HA-D.js";import{P as L}from"./PageHeader-BcBcU29I.js";import{E as a}from"./ExampleCard-BVwGIEPO.js";import{P as M,C as R,S as h,a as f,T as D}from"./ControlAccordion-DallGojj.js";import{W as p,X as F,Y as P,t as O}from"./options-D-FMIizr.js";const w=n=>n.map(t=>({...t,icon:void 0,children:t.children?w(t.children):void 0})),W=()=>{const[n,t]=l.useState("checkbox"),[s,I]=l.useState("md"),[u,j]=l.useState("blue"),[x,S]=l.useState(""),[r,y]=l.useState(!0),[C,c]=l.useState(["documents"]),[m,b]=l.useState([]),N=l.useMemo(()=>r?p:w(p),[r]),T=l.useMemo(()=>k(p),[]);return e.jsx(M,{controls:e.jsx(R,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(h,{label:"Selection mode",options:F,value:n,onChange:o=>{t(o),b([])}}),e.jsx(f,{label:"Size",children:e.jsx(E,{fullWidth:!0,size:"sm",options:P,value:s,onChange:o=>I(o)})}),e.jsx(h,{label:"Tone",options:O,value:u,onChange:o=>j(o)})]})},{id:"content",title:"Content",controls:e.jsx(f,{label:"Filter",children:e.jsx(v,{size:"sm",leadingIcon:"Search",placeholder:"Filter nodes…",value:x,onChange:o=>S(o.target.value)})})},{id:"icons",title:"Icons",controls:e.jsx("div",{className:"grid grid-cols-1 gap-2",children:e.jsx(D,{label:"Show icons",checked:r,onChange:y})})},{id:"actions",title:"Actions",controls:e.jsxs("div",{className:"grid grid-cols-2 gap-2",children:[e.jsx(d,{size:"sm",variant:"outline",onClick:()=>c(T),children:"Expand all"}),e.jsx(d,{size:"sm",variant:"outline",onClick:()=>c([]),children:"Collapse all"})]})}]}),preview:e.jsxs("div",{className:"flex w-full flex-col gap-3",children:[e.jsx("div",{className:"w-full max-w-md",children:e.jsx(i,{items:N,selectionMode:n,size:s,tone:u,filter:x,expandedIds:C,onExpandedChange:c,selectedIds:m,onSelectionChange:b,emptyMessage:"No nodes match.",ariaLabel:"Files"})}),n!=="none"&&e.jsxs("p",{className:"text-xs text-neutral-400 dark:text-neutral-500",children:["Selected:"," ",e.jsx("span",{className:"font-medium text-neutral-600 dark:text-neutral-300",children:m.length?m.join(", "):"none"})]})]})})},z=[{id:"documents",label:"Documents",icon:"Library",children:[{id:"work",label:"Work",icon:"ViewRows",children:[{id:"report",label:"Report.pdf",icon:"Log"},{id:"notes",label:"Notes.txt",icon:"Script"}]},{id:"personal",label:"Personal",icon:"User",children:[{id:"photos",label:"Photos",icon:"Image"},{id:"travel",label:"Travel",icon:"Globe"}]}]},{id:"downloads",label:"Downloads",icon:"Download"},{id:"media",label:"Media",icon:"Image"}];function U(){return e.jsx("div",{className:"w-full max-w-md",children:e.jsx(i,{items:z,defaultExpandedIds:["documents"],ariaLabel:"Files"})})}const B=`import { Tree, type TreeItem } from "@cjlapao/ui-kit";
...
`,Q=[{id:"documents",label:"Documents",icon:"Library",children:[{id:"work",label:"Work",icon:"ViewRows",children:[{id:"report",label:"Report.pdf",icon:"Log"},{id:"notes",label:"Notes.txt",icon:"Script"}]},{id:"personal",label:"Personal",icon:"User",children:[{id:"photos",label:"Photos",icon:"Image"},{id:"travel",label:"Travel",icon:"Globe"}]}]},{id:"development",label:"Development",icon:"Script",children:[{id:"projects",label:"Projects",icon:"Container",children:[{id:"ui-kit",label:"ui-kit",icon:"Rocket"},{id:"infra",label:"infra",icon:"CloudOff"}]},{id:"secrets",label:"secrets",icon:"Key"}]},{id:"media",label:"Media",icon:"Image"}];function Z(){const[n,t]=l.useState("");return e.jsxs("div",{className:"flex w-full max-w-md flex-col gap-3",children:[e.jsx(v,{leadingIcon:"Search",placeholder:"Filter nodes…",value:n,onChange:s=>t(s.target.value)}),e.jsx(i,{items:Q,defaultExpandedIds:["documents","development"],filter:n,emptyMessage:"No nodes match.",ariaLabel:"Files"})]})}const ee=`import { useState } from "react";
...
`,pe=()=>e.jsxs("div",{className:"mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-8 sm:px-8",children:[e.jsx(L,{name:"Tree",description:"Hierarchical data with expand/collapse branches, single, multiple and checkbox selection (with derived partial state), a case-insensitive filter and full roving-keyboard navigation."}),e.jsx(W,{}),e.jsxs("section",{className:"flex flex-col gap-5",children:[e.jsx("h2",{className:"text-xs font-semibold uppercase tracking-widest text-neutral-400 dark:text-neutral-500",children:"Examples"}),e.jsx(a,{title:"Basic",description:"Expand and collapse branches from the chevron; the row itself carries the selection.",code:B,filename:"Basic.tsx",children:e.jsx(U,{})}),e.jsx(a,{title:"Controlled",description:"Drive expansion from your own state with expandedIds, and expand or collapse everything in one click.",code:V,filename:"Controlled.tsx",children:e.jsx(K,{})}),e.jsx(a,{title:"Selection — single",description:"With selectionMode set to single, exactly one node stays selected and the selection is managed through selectedIds.",code:$,filename:"Single.tsx",children:e.jsx(G,{})}),e.jsx(a,{title:"Selection — multiple",description:"Click adds and removes nodes from the selection without any modifier key.",code:X,filename:"Multiple.tsx",children:e.jsx(_,{})}),e.jsx(a,{title:"Selection — checkbox",description:"Checkbox rows with the partial state: a parent reads as mixed while only some children are checked, and as checked once every child is.",code:J,filename:"Checkbox.tsx",children:e.jsx(q,{})}),e.jsx(a,{title:"Filter",description:"A case-insensitive substring match on labels; branches containing a match are shown expanded while the filter is active.",code:ee,filename:"Filter.tsx",children:e.jsx(Z,{})}),e.jsx(a,{title:"Keyboard",description:"Tab into the tree, then navigate with the arrow keys — Enter and Space select the focused node.",code:ie,filename:"Keyboard.tsx",children:e.jsx(le,{})}),e.jsx(a,{title:"Empty",description:"A friendly placeholder when there is nothing to show — it also appears when the filter matches no nodes.",code:oe,filename:"Empty.tsx",children:e.jsx(ae,{})})]})]});export{pe as TreePage,pe as default};
