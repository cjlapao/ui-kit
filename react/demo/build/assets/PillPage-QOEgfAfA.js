...
`,ve=()=>e.jsxs("div",{className:"mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-8 sm:px-8",children:[e.jsx(U,{name:"Pill",description:"Small labels for status and metadata. Three opaque variants plus two glass ones, the full tone set, optional icons, a remove button, and a bare status dot."}),e.jsx(ae,{}),e.jsxs("section",{className:"flex flex-col gap-5",children:[e.jsx("h2",{className:"text-xs font-semibold uppercase tracking-widest text-neutral-400 dark:text-neutral-500",children:"Examples"}),e.jsx(x,{title:"Status board",description:"A row of service states — filled, icon-led, outlined and a bare dot — each carrying its own tone.",code:se,filename:"StatusBoard.tsx",children:e.jsx(ne,{})}),e.jsx(x,{title:"Variants and tones",description:"All five variants side by side, then the full tone palette at once.",code:le,filename:"VariantsAndTones.tsx",children:e.jsx(te,{})}),e.jsx(x,{title:"Size ladder",description:"Pill and dot across the whole size scale — and a pill dot lines up with a Badge dot at the same size.",code:oe,filename:"SizeLadder.tsx",children:e.jsx(ie,{})}),e.jsx(x,{title:"Interactive tags",description:"Removable tags (removing never activates the pill), a clickable pill, a disabled one, a truncated label and a labelled dot.",code:de,filename:"InteractiveTags.tsx",children:e.jsx(re,{})})]})]});export{ve as PillPage,ve as default};
