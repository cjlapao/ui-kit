import{r as a,j as e,c1 as o,M as N,l as k}from"./index-p9Bv1Pn1.js";import{P as C}from"./PageHeader-DCZtzAyX.js";import{E as l}from"./ExampleCard-BS13YSEO.js";import{P as w,S as s,T as S,C as E}from"./PlaygroundPanel-BDClNSzf.js";import{C as O}from"./ControlAccordion-CydkdljU.js";import{d as H,t as P,n as B,p as M,bv as R,bw as z}from"./options-Bqu3_N-h.js";const L=["## Keyboard shortcuts","","Press **⌘K** for the command palette, or use these to move around:","","- `↑` / `↓` — move between rows","- `Enter` — open the focused item","- `Esc` — close this panel","","| Key | Action |","| --- | --- |","| `s` | Save draft |","| `p` | Publish |","","> Tip: every shortcut can be rebound under *Settings → Keyboard*."].join(`
`),G=e.jsxs("div",{className:"space-y-2 text-sm",children:[e.jsxs("p",{children:["Pass a ",e.jsx("code",{className:"rounded bg-neutral-100 px-1 font-mono text-xs",children:"ReactNode"})," ","and it renders as-is — bring your own layout and compose with any kit component."]}),e.jsxs("ul",{className:"list-disc space-y-0.5 pl-4",children:[e.jsx("li",{children:"Fully composable content"}),e.jsx("li",{children:"Stays on the panel's surface"})]})]}),W=()=>{const[t,x]=a.useState("elevated"),[i,g]=a.useState("blue"),[r,f]=a.useState("md"),[c,y]=a.useState("rounded-md"),[d,j]=a.useState("auto"),[h,v]=a.useState("markdown"),[u,b]=a.useState("360"),[p,T]=a.useState(!1);return e.jsx(w,{previewClassName:"w-full flex-col items-center gap-3",controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(O,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(s,{label:"Variant",options:H,value:t,onChange:n=>x(n)}),e.jsx(s,{label:"Tone",options:P,value:i,onChange:n=>g(n)}),e.jsx(s,{label:"Size",options:B,value:r,onChange:n=>f(n)}),e.jsx(s,{label:"Corner",options:M,value:c,onChange:n=>y(n)})]})},{id:"states",title:"States",controls:e.jsx(S,{label:"Loading",checked:p,onChange:T})},{id:"layout",title:"Layout",controls:e.jsxs(e.Fragment,{children:[e.jsx(s,{label:"Placement",options:R,value:d,onChange:n=>j(n)}),e.jsx(s,{label:"Max width",options:[{label:"280px",value:"280"},{label:"320px",value:"320"},{label:"360px",value:"360"},{label:"420px",value:"420"}],value:u,onChange:b})]})},{id:"content",title:"Content",controls:e.jsx(E,{label:"Content",children:e.jsx(N,{fullWidth:!0,size:"sm",options:z,value:h,onChange:v})})}]}),e.jsx("p",{className:"text-xs opacity-70",children:"Click the trigger to open the panel. The panel is a fixed popover, so it floats over the page."})]}),preview:e.jsxs("div",{className:"flex flex-col items-center gap-3",children:[e.jsx("div",{className:"rounded-2xl bg-gradient-to-br from-neutral-100 to-neutral-200 p-10 dark:from-neutral-800 dark:to-neutral-900",children:e.jsx(o,{content:h==="markdown"?L:G,title:"Help",variant:t,color:i,size:r,corner:c,placement:d,maxWidth:Number(u),loading:p})}),e.jsxs("span",{className:"text-xs opacity-70",children:[t," · ",i," · ",r," · ",c," · ",d,p?" · loading":""]})]})})},A=["## Getting started","","HelpButton renders its **content** as Markdown when you pass a string.","","1. Write the copy as GitHub-flavoured Markdown","2. Pass it as a `string`","3. The body is scrollable and links open in a new tab","","| Prop | Type |","| --- | --- |","| `content` | `string` or `ReactNode` |","| `color` | any of 21 tones |","","Try it: [read the full docs](https://example.com)."].join(`
