...
`,X="mb-2 text-sm font-medium text-neutral-900 dark:text-neutral-100",Y={solid:"Solid",soft:"Soft",outline:"Outline",ghost:"Ghost",glass:"Glass"};function Z(){return e.jsx("div",{className:"grid w-full max-w-2xl grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2",children:T.map(n=>e.jsxs("div",{children:[e.jsx("h4",{className:X,children:Y[n]??n}),e.jsx(l,{variant:n,defaultValue:50})]},n))})}const J=`import { Slider, SLIDER_VARIANTS } from "@cjlapao/ui-kit";
...
`;function K(){const[n,s]=t.useState(20);return e.jsxs("div",{className:"flex w-full max-w-md flex-col items-center gap-3",children:[e.jsx(l,{value:n,onChange:a=>s(a),step:20}),e.jsxs("span",{className:"font-mono text-sm text-neutral-500 dark:text-neutral-400",children:["Value:"," ",e.jsx("strong",{className:"text-neutral-900 dark:text-neutral-100",children:n})]})]})}const Q=`import { useState } from "react";
