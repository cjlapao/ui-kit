import{r as s,D as B,j as e,b8 as c,M as d,e as Y}from"./index-p9Bv1Pn1.js";import{P as q}from"./PageHeader-DCZtzAyX.js";import{E as b}from"./ExampleCard-BS13YSEO.js";import{P as H,S as v,C as i,T as A}from"./PlaygroundPanel-BDClNSzf.js";import{C as J}from"./ControlAccordion-CydkdljU.js";import{aL as Q,t as X,p as Z,e as ee,aM as ne,n as te,j as se,k as ae,l as oe}from"./options-Bqu3_N-h.js";const ie=["glass","liquid-glass","default"],j=12,T=60,re=()=>{const[t,a]=s.useState(()=>Array.from({length:j},(n,h)=>h)),[g,m]=s.useState(!1),[u,o]=s.useState("outlined"),[r,p]=s.useState("blue"),[w,O]=s.useState(B),[S,G]=s.useState("sm"),[l,_]=s.useState("masonry"),[L,F]=s.useState("md"),[x,W]=s.useState(4),[f,k]=s.useState(!1),[y,M]=s.useState(!1),[I,R]=s.useState("frosted"),[C,$]=s.useState("medium"),[N,z]=s.useState("classic"),P=s.useRef(f);P.current=f;const K=!y&&t.length<T,V=s.useCallback(async()=>{if(m(!0),await new Promise(n=>setTimeout(n,900)),m(!1),P.current)throw new Error("Simulated network failure");a(n=>[...n,...Array.from({length:j},(h,U)=>n.length+U)])},[]),D=ie.includes(u);return e.jsx(H,{controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(J,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(v,{label:"Variant",options:Q,value:u,onChange:n=>o(n)}),e.jsx(v,{label:"Tone",options:X,value:r,onChange:n=>p(n)}),e.jsx(v,{label:"Corner",options:Z,value:w,onChange:n=>O(n)}),e.jsx(i,{label:"Padding",children:e.jsx(d,{fullWidth:!0,size:"sm",options:ee,value:S,onChange:n=>G(n)})}),e.jsx(i,{label:"Layout",children:e.jsx(d,{fullWidth:!0,size:"sm",options:ne,value:l,onChange:n=>_(n)})})]})},{id:"layout",title:"Layout",controls:e.jsxs(e.Fragment,{children:[e.jsx(i,{label:"Gap",children:e.jsx(d,{fullWidth:!0,size:"sm",options:te,value:L,onChange:n=>F(n)})}),e.jsx(i,{label:`Max columns — ${x}`,children:e.jsx("input",{type:"range",min:1,max:6,value:x,onChange:n=>W(Number(n.target.value)),className:"w-full accent-blue-500"})})]})},{id:"content",title:"Content",controls:e.jsxs("div",{className:"grid grid-cols-1 gap-2",children:[e.jsx(A,{label:"Empty",checked:y,onChange:M}),e.jsx(A,{label:"Next page fails",checked:f,onChange:k}),e.jsx(Y,{size:"xs",variant:"soft",color:r,onClick:()=>{a(Array.from({length:j},(n,h)=>h)),M(!1),k(!1)},children:"Reset"})]})},...D?[{id:"glass",title:"Glass",controls:e.jsxs(e.Fragment,{children:[e.jsx(i,{label:"Specular",children:e.jsx(d,{fullWidth:!0,size:"sm",options:se,value:N,onChange:n=>z(n)})}),e.jsx(i,{label:"Vibrancy",children:e.jsx(d,{fullWidth:!0,size:"sm",options:ae,value:C,onChange:n=>$(n)})}),e.jsx(i,{label:"Glass opacity",children:e.jsx(d,{fullWidth:!0,size:"sm",options:oe,value:I,onChange:n=>R(n)})})]})}]:[]]}),e.jsxs("p",{className:"text-xs opacity-70",children:[t.length," of ",T," loaded. ",e.jsx("strong",{children:"Columns"})," fills each column top-to-bottom, so reading order runs down rather than across — ",e.jsx("strong",{children:"grid"})," keeps left-to-right order."," ",e.jsx("strong",{children:"Next page fails"})," shows the retry state."]})]}),preview:e.jsx("div",{className:"w-full",children:e.jsx("div",{className:"w-full rounded-lg bg-gradient-to-br from-indigo-100 via-neutral-50 to-rose-100 p-4 dark:from-slate-900 dark:via-neutral-950 dark:to-indigo-950",children:e.jsx(c,{items:y?[]:t,isLoading:g&&t.length===0,hasMore:K,onLoadMore:V,variant:u,tone:r,corner:w,padding:S,layout:l,gap:L,maxColumns:x,minColumnWidth:220,height:480,glassOpacity:I,vibrancy:C,specularMode:N,getItemKey:n=>n,renderItem:n=>e.jsxs("div",{className:"w-full rounded-lg border border-black/10 bg-white/70 p-4 shadow-sm dark:border-white/10 dark:bg-neutral-900/60",style:l==="masonry"||l==="columns"?{height:`${90+n%5*36}px`}:void 0,children:[e.jsxs("div",{className:"font-semibold",children:["Item ",n]}),e.jsx("div",{className:"mt-1 text-xs opacity-60",children:l==="masonry"||l==="columns"?`${90+n%5*36}px tall`:"uniform height"})]})})})})})},E=8,le=24;function de(){const[t,a]=s.useState(()=>Array.from({length:E},(o,r)=>r)),[g,m]=s.useState(!1),u=s.useCallback(async()=>{m(!0),await new Promise(o=>setTimeout(o,600)),m(!1),a(o=>[...o,...Array.from({length:E},(r,p)=>o.length+p)])},[]);return e.jsx(c,{items:t,isLoading:g&&t.length===0,hasMore:t.length<le,onLoadMore:u,variant:"outlined",tone:"indigo",layout:"masonry",minColumnWidth:220,height:420,endMessage:"That is every post in the feed.",getItemKey:o=>o,renderItem:o=>e.jsxs("div",{className:"w-full rounded-lg border border-black/10 bg-white/70 p-4 shadow-sm dark:border-white/10 dark:bg-neutral-900/60",style:{height:`${90+o%5*36}px`},children:[e.jsxs("div",{className:"font-semibold",children:["Post ",o+1]}),e.jsxs("div",{className:"mt-1 text-xs opacity-60",children:[90+o%5*36,"px tall"]})]})})}const ce=`import { useCallback, useState } from "react";
