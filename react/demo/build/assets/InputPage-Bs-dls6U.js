...
`;function ae(){return e.jsx("div",{className:"flex flex-col gap-3",children:G.map(s=>e.jsx(a,{color:"blue",size:s,placeholder:`Size ${s}`},s))})}const ne=`import { CONTROL_SIZES, Input } from "@cjlapao/ui-kit";
...
`;function le(){return e.jsx("div",{className:"grid gap-2 md:grid-cols-3",children:R.map(s=>e.jsx(a,{size:"sm",color:s,placeholder:s},s))})}const se=`import { Input, TRUE_COLORS } from "@cjlapao/ui-kit";
