import{r as a,j as e,T as l,M as n,m as M}from"./index-BBK6HA-D.js";import{P as I}from"./PageHeader-BcBcU29I.js";import{E as o}from"./ExampleCard-BVwGIEPO.js";import{P,C as B,S as C,a as i,T as r}from"./ControlAccordion-DallGojj.js";import{w as R,n as W,t as F,k as _,l as q,j as H}from"./options-D-FMIizr.js";const U=[{label:"Left",value:"left"},{label:"Right",value:"right"}],J=[{label:"Stacked",value:"stacked"},{label:"Inline",value:"inline"}],K=()=>{const[s,w]=a.useState("solid"),[u,S]=a.useState("md"),[g,T]=a.useState("left"),[f,y]=a.useState("stacked"),[h,O]=a.useState("blue"),[c,z]=a.useState(!0),[x,N]=a.useState(!0),[d,L]=a.useState(!1),[m,E]=a.useState(!1),[b,D]=a.useState(!1),[p,A]=a.useState("medium"),[j,V]=a.useState("frosted"),[v,G]=a.useState("none"),k={variant:s,size:u,color:h,alignLabel:g,descriptionPlacement:f,fullWidth:m,vibrancy:p,glassOpacity:j,specularMode:v,iconOn:d?"Sun":void 0,iconOff:d?"Moon":void 0,disabled:b};return e.jsx(P,{controls:e.jsx(B,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(C,{label:"Variant",options:R,value:s,onChange:t=>w(t)}),e.jsx(i,{label:"Size",children:e.jsx(n,{fullWidth:!0,size:"sm",options:W,value:u,onChange:t=>S(t)})}),e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsx(i,{label:"Label alignment",children:e.jsx(n,{fullWidth:!0,size:"sm",options:U,value:g,onChange:t=>T(t)})}),e.jsx(i,{label:"Description",children:e.jsx(n,{fullWidth:!0,size:"sm",options:J,value:f,onChange:t=>y(t)})})]}),e.jsx(C,{label:"Color",options:F,value:h,onChange:t=>O(t)})]})},...s==="glass"?[{id:"glass",title:"Glass",controls:e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsx(i,{label:"Vibrancy",children:e.jsx(n,{fullWidth:!0,size:"sm",options:_,value:p,onChange:t=>A(t)})}),e.jsx(i,{label:"Fill",children:e.jsx(n,{fullWidth:!0,size:"sm",options:q,value:j,onChange:t=>V(t)})}),e.jsx(i,{label:"Specular",children:e.jsx(n,{fullWidth:!0,size:"sm",options:H,value:v,onChange:t=>G(t)})})]})}]:[],{id:"content",title:"Content",controls:e.jsxs("div",{className:"grid grid-cols-2 gap-2",children:[e.jsx(r,{label:"Label",checked:c,onChange:z}),e.jsx(r,{label:"Description",checked:x,onChange:N}),e.jsx(r,{label:"Icons",checked:d,onChange:L}),e.jsx(r,{label:"Full width",checked:m,onChange:E}),e.jsx(r,{label:"Disabled",checked:b,onChange:D})]})}]}),preview:e.jsx("div",{className:"w-full",children:e.jsxs("div",{className:"flex flex-col gap-4 rounded-lg bg-gradient-to-br from-indigo-100 via-neutral-50 to-rose-100 p-4 dark:from-slate-900 dark:via-neutral-950 dark:to-indigo-950",children:[e.jsx(l,{...k,label:c?"Two-factor authentication":void 0,description:x?"Require a code from your phone to sign in.":void 0,defaultChecked:!0}),e.jsx(l,{...k,label:c?"Marketing emails":void 0})]})})})};function Q(){return e.jsx(l,{color:"blue",label:"Enable notifications",defaultChecked:!0})}const X=`import { Toggle } from "@cjlapao/ui-kit";
...
`,Y={solid:"Solid",soft:"Soft",outline:"Outline",ghost:"Ghost",glass:"Glass"},Z="flex items-center justify-between gap-6 rounded-lg bg-gradient-to-br from-indigo-100 via-neutral-50 to-rose-100 p-4 dark:from-slate-900 dark:via-neutral-950 dark:to-indigo-950";function $(){return e.jsx("div",{className:"grid w-full max-w-2xl grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2",children:M.map(s=>e.jsxs("div",{className:Z,children:[e.jsx("span",{className:"text-sm font-medium text-neutral-900 dark:text-neutral-100",children:Y[s]??s}),e.jsxs("span",{className:"flex items-center gap-4",children:[e.jsx(l,{variant:s}),e.jsx(l,{variant:s,defaultChecked:!0})]})]},s))})}const ee=`import { TOGGLE_VARIANTS, Toggle } from "@cjlapao/ui-kit";
