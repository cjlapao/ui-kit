import{r as a,j as e,bD as s,I as E,J as V}from"./index-p9Bv1Pn1.js";import{P as A}from"./PageHeader-DCZtzAyX.js";import{E as u}from"./ExampleCard-BS13YSEO.js";import{P as M,a as l,C as O,T as i}from"./PlaygroundPanel-BDClNSzf.js";import{C as R}from"./ControlAccordion-CydkdljU.js";import{x as L,t as z,n as q,b2 as B,K as D}from"./options-Bqu3_N-h.js";const G=[{id:"prod",label:"prod"},{id:"staging",label:"staging"},{id:"gpu",label:"gpu"},{id:"docker",label:"docker"},{id:"beta",label:"beta"}],U=()=>{const[n,o]=a.useState(["prod"]),[d,w]=a.useState("blue"),[c,b]=a.useState("md"),[r,k]=a.useState("flat"),[p,C]=a.useState("none"),[g,y]=a.useState("soft"),[h,N]=a.useState(!0),[m,S]=a.useState(!0),[f,T]=a.useState(!1),[v,I]=a.useState(!1),[j,P]=a.useState(!0);return e.jsx(M,{controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(R,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(l,{label:"Variant",options:L,value:r,onChange:t=>k(t)}),e.jsx(l,{label:"Tone",options:z,value:d,onChange:t=>w(t)}),e.jsx(l,{label:"Size",options:q,value:c,onChange:t=>b(t)}),e.jsx(l,{label:"Validation",options:B,value:p,onChange:t=>C(t)})]})},...r==="gradient"?[{id:"glow",title:"Glow",controls:e.jsx(l,{label:"Glow",options:D,value:g,onChange:t=>y(t)})}]:[],{id:"behaviour",title:"Behaviour",controls:e.jsx(O,{label:"Behaviour",children:e.jsxs("div",{className:"space-y-1.5",children:[e.jsx(i,{label:"Multi-select",checked:h,onChange:N}),e.jsx(i,{label:"Allow create",checked:m,onChange:S}),e.jsx(i,{label:"Read-only",checked:f,onChange:T}),e.jsx(i,{label:"Loading",checked:v,onChange:I}),e.jsx(i,{label:"Compare with Input",checked:j,onChange:P})]})})}]}),e.jsxs("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:["Type something that does not match to see the create row, and use the arrow keys and Enter. Items added this session are flagged"," ",e.jsx("strong",{children:"new"}),". The surface, padding, type scale and focus treatment come from the shared field system — the same one"," ",e.jsx("code",{children:"Input"}),", ",e.jsx("code",{children:"Select"})," and ",e.jsx("code",{children:"Picker"})," use."]})]}),preview:e.jsxs("div",{className:"flex w-full max-w-sm flex-col gap-3",children:[e.jsx(s,{items:G,value:n,onChange:o,tone:d,size:c,variant:r,validationStatus:p,glowIntensity:g,multi:h,allowCreate:m,readOnly:f,loading:v}),j&&e.jsx(E,{placeholder:"An Input, same size and variant",tone:d,size:c,variant:r,validationStatus:p,glowIntensity:g})]})})};function _(){const[n,o]=a.useState(["prod"]);return e.jsx("div",{className:"w-full max-w-sm",children:e.jsx(s,{allowCreate:!0,items:[{id:"prod",label:"prod"},{id:"staging",label:"staging"}],value:n,onChange:o})})}const $=`import { useState } from "react";
