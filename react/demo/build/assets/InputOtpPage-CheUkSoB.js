import{r as l,j as e,X as t,e as o,M as i}from"./index-BBK6HA-D.js";import{P as w}from"./PageHeader-BcBcU29I.js";import{E as a}from"./ExampleCard-BVwGIEPO.js";import{P as I,C as y,a as u,S as z,T as d}from"./ControlAccordion-DallGojj.js";import{Q as N,t as V}from"./options-D-FMIizr.js";const P=[{label:"4",value:"4"},{label:"6",value:"6"},{label:"8",value:"8"}],B=[{label:"Small",value:"sm"},{label:"Medium",value:"md"},{label:"Large",value:"lg"}],M=()=>{const[n,r]=l.useState(6),[c,j]=l.useState("outlined"),[p,v]=l.useState("md"),[x,k]=l.useState("blue"),[m,C]=l.useState(!1),[h,O]=l.useState(!1),[f,S]=l.useState(!1),[g,b]=l.useState("");return e.jsx(I,{controls:e.jsx(y,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(u,{label:"Length",children:e.jsx(i,{fullWidth:!0,size:"sm",options:P,value:String(n),onChange:s=>r(Number(s))})}),e.jsx(u,{label:"Variant",children:e.jsx(i,{fullWidth:!0,size:"sm",options:N,value:c,onChange:s=>j(s)})}),e.jsx(u,{label:"Size",children:e.jsx(i,{fullWidth:!0,size:"sm",options:B,value:p,onChange:s=>v(s)})}),e.jsx(z,{label:"Tone",options:V,value:x,onChange:s=>k(s)})]})},{id:"options",title:"Options",controls:e.jsxs("div",{className:"grid grid-cols-1 gap-2",children:[e.jsx(d,{label:"Mask",checked:m,onChange:C}),e.jsx(d,{label:"Integer only",checked:h,onChange:O}),e.jsx(d,{label:"Disabled",checked:f,onChange:S})]})}]}),preview:e.jsxs("div",{className:"flex w-full max-w-sm flex-col items-center gap-3",children:[e.jsx(t,{length:n,variant:c,size:p,tone:x,mask:m,integerOnly:h,disabled:f,value:g,onChange:b}),e.jsxs("div",{className:"flex items-center gap-3 text-sm text-neutral-500 dark:text-neutral-400",children:[e.jsxs("span",{children:["Value:"," ",e.jsx("strong",{className:"text-neutral-900 dark:text-neutral-100",children:g||"—"})]}),e.jsx(o,{variant:"soft",size:"sm",onClick:()=>b(""),children:"Reset"})]})]})})};function A(){return e.jsx(t,{length:6})}const T=`import { InputOtp } from "@cjlapao/ui-kit";
...
`;function Q(){return e.jsxs("div",{className:"flex flex-col items-center gap-4",children:[e.jsx(t,{length:4,size:"sm"}),e.jsx(t,{length:4,size:"md"}),e.jsx(t,{length:4,size:"lg"})]})}const U=`import { InputOtp } from "@cjlapao/ui-kit";
...
`;function X(){return e.jsx(t,{length:6,disabled:!0,defaultValue:"482913"})}const q=`import { InputOtp } from "@cjlapao/ui-kit";

export default function Disabled() {
  return <InputOtp length={6} disabled defaultValue="482913" />;
}
`;function G(){return e.jsx(t,{length:4,defaultValue:"48",renderCell:n=>e.jsx("input",{...n.inputProps,className:"h-14 w-10 appearance-none rounded-none border-0 border-b-2 border-neutral-300 bg-transparent p-0 text-center text-2xl font-semibold text-neutral-900 outline-none transition-colors focus:border-blue-400 dark:border-neutral-600 dark:text-neutral-50 dark:focus:border-blue-400"})})}const J=`import { InputOtp } from "@cjlapao/ui-kit";
