import{r as n,j as e,P as J,bb as r,e as d,M as a,I as K,t as Q,af as X,ag as Z}from"./index-BBK6HA-D.js";import{P as ee}from"./PageHeader-BcBcU29I.js";import{E as c}from"./ExampleCard-BVwGIEPO.js";import{P as te,C as ne,a as i,S as p,T as l}from"./ControlAccordion-DallGojj.js";import{aT as se,aU as ie,n as oe,p as ae,aV as le,aW as re,t as ce,j as de,k as ue,l as he}from"./options-D-FMIizr.js";const pe="rounded-md",xe="Rollout is held at 12% of traffic. The error budget for this window is spent, so the next attempt needs either a fix or an explicit override from someone on the release rota. Nothing is being served from the new build.",me=["glass","liquid-glass"],fe=()=>{const[s,u]=n.useState("danger"),[x,R]=n.useState("subtle"),[b,B]=n.useState("md"),[A,E]=n.useState(pe),[w,D]=n.useState(!0),[m,V]=n.useState("auto"),[S,L]=n.useState("top"),[h,W]=n.useState(!1),[f,_]=n.useState("violet"),[N,G]=n.useState("Deployment paused"),[g,P]=n.useState("We paused the rollout while we investigate a spike in error rates."),[y,F]=n.useState(!1),[o,M]=n.useState(!1),[C,$]=n.useState(!1),[j,q]=n.useState(!1),[O,v]=n.useState(!0),[T,U]=n.useState("classic"),[z,Y]=n.useState("medium"),[I,H]=n.useState("frosted"),k=me.includes(x);return e.jsx(te,{controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(ne,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(i,{label:"Intent",children:e.jsx(a,{fullWidth:!0,size:"sm",options:se,value:s,onChange:t=>u(t)})}),e.jsx(p,{label:"Variant",options:ie,value:x,onChange:t=>R(t)}),e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsx(i,{label:"Size",children:e.jsx(a,{fullWidth:!0,size:"sm",options:oe,value:b,onChange:t=>B(t)})}),e.jsx(p,{label:"Corner",options:ae,value:A,onChange:t=>E(t)})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsx(p,{label:"Icon size",options:le,value:m,onChange:t=>V(t)}),e.jsx(i,{label:"Icon alignment",children:e.jsx(a,{fullWidth:!0,size:"sm",options:re,value:S,onChange:t=>L(t)})})]})]})},{id:"tone",title:"Tone",controls:e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"grid grid-cols-1 gap-2",children:e.jsx(l,{label:"Override the intent's tone",checked:h,onChange:W})}),h&&e.jsx(p,{label:"Colour",options:ce,value:f,onChange:t=>_(t)})]})},{id:"content",title:"Content",controls:e.jsxs(e.Fragment,{children:[e.jsx(i,{label:"Title",children:e.jsx(K,{size:"sm",value:N,onChange:t=>G(t.target.value)})}),e.jsx(i,{label:"Description",children:e.jsx(Q,{size:"sm",rows:3,value:g,onChange:t=>P(t.target.value)})})]})},{id:"states",title:"States",controls:e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"grid grid-cols-2 gap-2",children:[e.jsx(l,{label:"Icon",checked:w,onChange:D}),e.jsx(l,{label:"Dismissible",checked:o,onChange:t=>{M(t),v(!0)}}),e.jsx(l,{label:"Long body",checked:y,onChange:F}),e.jsx(l,{label:"Actions",checked:C,onChange:$}),e.jsx(l,{label:"On a glass panel",checked:j,onChange:q})]}),o&&!O&&e.jsx(d,{size:"xs",variant:"outline",color:"blue",onClick:()=>v(!0),children:"Reset the alert"})]})},...k?[{id:"glass",title:"Glass",controls:e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsx(i,{label:"Specular",children:e.jsx(a,{fullWidth:!0,size:"sm",options:de,value:T,onChange:t=>U(t)})}),e.jsx(i,{label:"Vibrancy",children:e.jsx(a,{fullWidth:!0,size:"sm",options:ue,value:z,onChange:t=>Y(t)})}),e.jsx(i,{label:"Glass opacity",children:e.jsx(a,{fullWidth:!0,size:"sm",options:he,value:I,onChange:t=>H(t)})})]})}]:[]]}),e.jsxs("p",{className:"text-xs opacity-70",children:[e.jsx("strong",{children:"Intent"})," is the semantic axis — it chooses the tone, the default icon and whether the callout is announced"," ",e.jsx("code",{children:"assertive"})," (interrupting the reader, for a failure) or"," ",e.jsx("code",{children:"polite"}),". Turn on the override to reach the full 21-colour scale instead."]})]}),preview:e.jsx("div",{className:"w-full",children:e.jsx(J,{variant:j?"liquid-glass":"outlined",tone:j?h?f:"blue":"neutral",padding:"md",children:e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsx(r,{intent:s,variant:x,size:b,corner:A,iconAlign:S,iconSize:m==="auto"?void 0:m,color:h?f:void 0,glassOpacity:I,vibrancy:z,specularMode:k?T:"none",title:N||void 0,description:y?`${g} ${xe}`:g||void 0,icon:w?void 0:!1,dismissible:o,open:o?O:void 0,onDismiss:o?()=>v(!1):void 0,actions:C?e.jsxs("div",{className:"flex flex-wrap gap-2",children:[e.jsx(d,{size:"xs",variant:"soft",color:"blue",children:"Resume rollout"}),e.jsx(d,{size:"xs",variant:"ghost",color:"slate",children:"Snooze"})]}):void 0}),o&&e.jsx("span",{className:"text-xs opacity-60",children:"Dismiss it — it hides itself with no state on your side."})]})})})})};function ge(){return e.jsx("div",{className:"flex w-full flex-col gap-2",children:X.map(s=>e.jsx(r,{intent:s,size:"sm",title:s.charAt(0).toUpperCase()+s.slice(1),description:"Each intent picks its own tone, icon and announcement politeness."},s))})}const je=`import { ALERT_INTENTS, Alert } from "@cjlapao/ui-kit";
...
`;function ve(){return e.jsx("div",{className:"grid w-full gap-2 md:grid-cols-2",children:Z.map(s=>e.jsx(r,{variant:s,intent:"info",size:"sm",title:s,description:"Same message, five surfaces."},s))})}const be=`import { ALERT_VARIANTS, Alert } from "@cjlapao/ui-kit";
