...
`,le=()=>e.jsxs("div",{className:"mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-8 sm:px-8",children:[e.jsx($,{name:"Progress",description:"A determinate or indeterminate progress bar. Size and tone come from the shared scales; the motion overlays are driven by classes so a reduced-motion preference can switch them off."}),e.jsx(U,{}),e.jsxs("section",{className:"flex flex-col gap-5",children:[e.jsx("h2",{className:"text-xs font-semibold uppercase tracking-widest text-neutral-400 dark:text-neutral-500",children:"Examples"}),e.jsx(d,{title:"Every motion",description:"All six overlays — none, shimmer, pulse, shimmer-pulse, stripes and stripes-shimmer — at the same value.",code:F,filename:"EveryMotion.tsx",children:e.jsx(q,{})}),e.jsx(d,{title:"Size ladder",description:"The shared control scale — the track runs from a hairline to a chunky bar.",code:K,filename:"SizeLadder.tsx",children:e.jsx(J,{})}),e.jsx(d,{title:"Indeterminate",description:"Extent unknown, so the bar sweeps and no percentage is shown — and no aria-valuenow is published.",code:X,filename:"Indeterminate.tsx",children:e.jsx(Q,{})}),e.jsx(d,{title:"Custom range",description:"An arbitrary min–max with its own units, formatted for the label and for aria-valuetext.",code:ee,filename:"CustomRange.tsx",children:e.jsx(Y,{})})]})]});export{le as ProgressPage,le as default};
