import{r as n,j as e,P,O as l,M as b,J as $,p as A,m as _}from"./index-CASQDqc_.js";import{P as M}from"./PageHeader-DxnWpf-v.js";import{E as c}from"./ExampleCard-D_CxWJdb.js";import{P as U,S as v,C as O,T as i}from"./PlaygroundPanel-B62eNAMn.js";import{C as H}from"./ControlAccordion-BafxVZvc.js";import{x as D,n as B,t as W,J as Z}from"./options-D2wLByKW.js";const F=({children:a})=>e.jsx("span",{className:"text-[11px] font-semibold uppercase tracking-wide opacity-60",children:a}),J=["eu-west-1","us-east-1","ap-south-1","sa-east-1"],q=()=>{const[a,t]=n.useState("flat"),[x,N]=n.useState("md"),[d,w]=n.useState("blue"),[m,C]=n.useState("none"),[p,I]=n.useState(""),[u,E]=n.useState([]),[g,R]=n.useState(!1),[S,k]=n.useState(!0),[j,z]=n.useState(!1),[r,T]=n.useState(!1),[f,y]=n.useState(!1),[h,G]=n.useState(!1),V=r?u.length?u.map(s=>`region[]=${s}`).join("&"):"— nothing selected —":p?`region=${p}`:"— no selection —";return e.jsx(U,{controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(H,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(v,{label:"Variant",options:D,value:a,onChange:s=>t(s)}),e.jsx(O,{label:"Size",children:e.jsx(b,{fullWidth:!0,size:"sm",options:B,value:x,onChange:s=>N(s)})}),e.jsx(v,{label:"Tone",options:W,value:d,onChange:s=>w(s)}),e.jsx(O,{label:"Validation",children:e.jsx(b,{fullWidth:!0,size:"sm",options:Z,value:m,onChange:s=>C(s)})})]})},{id:"options",title:"Options",controls:e.jsxs("div",{className:"grid grid-cols-2 gap-2",children:[e.jsx(i,{label:"Leading icon",checked:g,onChange:R}),e.jsx(i,{label:"Placeholder",checked:S,onChange:k}),e.jsx(i,{label:"Hide caret",checked:j,onChange:z}),e.jsx(i,{label:"Multiple",checked:r,onChange:T}),e.jsx(i,{label:"Disabled",checked:f,onChange:y}),e.jsx(i,{label:"On a glass panel",checked:h,onChange:G})]})}]}),e.jsxs("p",{className:"text-xs opacity-70",children:["The surface sits on the field's wrapper, not the"," ",e.jsx("code",{children:"<select>"})," — same structure as"," ",e.jsx("strong",{children:"Input"}),", so the caret and leading icon are flex siblings. The ",e.jsx("code",{children:"<option>"})," elements carry their own fill: the native dropdown is painted by the platform from the select's background, which is now transparent."]})]}),preview:e.jsx("div",{className:"w-full",children:e.jsx(P,{variant:h?"liquid-glass":"outlined",tone:h?d:"neutral",padding:"md",children:e.jsxs("div",{className:"flex w-full max-w-sm flex-col gap-4",children:[e.jsx(l,{variant:a,size:x,tone:d,validationStatus:m,disabled:f,multiple:r,leadingIcon:g?"Globe":void 0,hideCaret:j,placeholder:S?"Choose a region":void 0,value:r?u:p,onChange:s=>{r?E(Array.from(s.target.selectedOptions,L=>L.value)):I(s.target.value)},"aria-label":"Region",children:J.map(s=>e.jsx("option",{value:s,children:s},s))}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx(F,{children:"What a form submit would carry"}),e.jsx("code",{className:"rounded-lg bg-black/5 px-3 py-2 text-xs dark:bg-white/10",children:V})]})]})})})})},K=["eu-west-1","us-east-1","ap-south-1","sa-east-1"],Q=()=>e.jsx("div",{className:"grid w-full gap-3 md:grid-cols-2",children:$.map(a=>e.jsx(l,{variant:a,size:"md",placeholder:a,"aria-label":a,children:K.map(t=>e.jsx("option",{value:t,children:t},t))},a))}),X=`import { INPUT_VARIANTS, Select } from "@cjlapao/ui-kit";
