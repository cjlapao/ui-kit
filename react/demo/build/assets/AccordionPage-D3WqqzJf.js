import{r as t,D as B,u as O,j as e,e as T,A as p,M as s}from"./index-BBK6HA-D.js";import{P as Q}from"./PageHeader-BcBcU29I.js";import{E as b}from"./ExampleCard-BVwGIEPO.js";import{P as Y,C as $,S as y,a as i,T as l}from"./ControlAccordion-DallGojj.js";import{d as J,t as K,p as X,e as Z,n as ee,j as ne,k as te,l as ae}from"./options-D-FMIizr.js";const se=["glass","liquid-glass","default"],ie=[{label:"Chevron",value:"chevron"},{label:"Plus/Minus",value:"plus-minus"},{label:"None",value:"none"}],oe=[{label:"Left",value:"left"},{label:"Right",value:"right"}],le=[{id:"region-us",title:"United States",subtitle:"us-east-1 · N. Virginia",description:"Low latency for east coast workloads.",badge:"Primary",content:"Availability zones: 3 — average latency 22 ms. GPU instances and spot capacity are available."},{id:"region-eu",title:"Europe",subtitle:"eu-central-1 · Frankfurt",description:"Ideal for GDPR-compliant workloads.",badge:"High demand",content:"Availability zones: 2 — average latency 39 ms. Maintenance window Sundays 02:00–04:00 CET."},{id:"region-apac",title:"Asia Pacific",subtitle:"ap-southeast-1 · Singapore",description:"Great for APAC users and low-latency APIs.",badge:"New",content:"Availability zones: 3 — average latency 55 ms. Dedicated bare-metal hosts available on request."}],re=()=>{const[r,c]=t.useState("elevated"),[o,g]=t.useState("neutral"),[a,d]=t.useState(B),[u,z]=t.useState("md"),[x,E]=t.useState("md"),[v,G]=t.useState("chevron"),[j,R]=t.useState("right"),[h,q]=t.useState(!1),[w,D]=t.useState(!0),[S,L]=t.useState(!1),[m,F]=t.useState(!0),[A,M]=t.useState(!0),[k,f]=t.useState(!1),[I,W]=t.useState("classic"),[C,U]=t.useState("medium"),[P,V]=t.useState("frosted"),N=O({defaultOpenIds:["region-us"],multiple:h}),H=se.includes(r),_=le.map(n=>({id:n.id,title:n.title,subtitle:n.subtitle,description:n.description,icon:m?"Globe":void 0,badge:m?n.badge:void 0,content:e.jsx("p",{children:n.content}),actions:A&&n.id==="region-us"?e.jsx(T,{size:"xs",variant:"ghost",color:o,onClick:()=>{f(!0),setTimeout(()=>f(!1),1200)},children:"Refresh"}):void 0}));return e.jsx(Y,{controls:e.jsx($,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(y,{label:"Variant",options:J,value:r,onChange:n=>c(n)}),e.jsx(y,{label:"Tone",options:K,value:o,onChange:n=>g(n)}),e.jsx(y,{label:"Corner",options:X,value:a,onChange:n=>d(n)}),e.jsx(i,{label:"Padding",children:e.jsx(s,{fullWidth:!0,size:"sm",options:Z,value:u,onChange:n=>z(n)})}),e.jsx(i,{label:"Size",children:e.jsx(s,{fullWidth:!0,size:"sm",options:ee,value:x,onChange:n=>E(n)})}),e.jsx(i,{label:"Indicator",children:e.jsx(s,{fullWidth:!0,size:"sm",options:ie,value:v,onChange:n=>G(n)})}),e.jsx(i,{label:"Indicator placement",children:e.jsx(s,{fullWidth:!0,size:"sm",options:oe,value:j,onChange:n=>R(n)})})]})},{id:"states",title:"States",controls:e.jsxs("div",{className:"grid grid-cols-1 gap-2",children:[e.jsx(l,{label:"Multiple open",checked:h,onChange:q}),e.jsx(l,{label:"Animated",checked:w,onChange:D}),e.jsx(l,{label:"Disabled",checked:S,onChange:L}),e.jsx(l,{label:"Icons and badges",checked:m,onChange:F}),e.jsx(l,{label:"Header action",checked:A,onChange:M}),e.jsx(l,{label:"Loading",checked:k,onChange:f})]})},...H?[{id:"glass",title:"Glass",controls:e.jsxs(e.Fragment,{children:[e.jsx(i,{label:"Specular",children:e.jsx(s,{fullWidth:!0,size:"sm",options:ne,value:I,onChange:n=>W(n)})}),e.jsx(i,{label:"Vibrancy",children:e.jsx(s,{fullWidth:!0,size:"sm",options:te,value:C,onChange:n=>U(n)})}),e.jsx(i,{label:"Glass opacity",children:e.jsx(s,{fullWidth:!0,size:"sm",options:ae,value:P,onChange:n=>V(n)})})]})}]:[]]}),preview:e.jsx("div",{className:"w-full",children:e.jsx("div",{className:"w-full rounded-lg bg-gradient-to-br from-indigo-100 via-neutral-50 to-rose-100 p-4 dark:from-slate-900 dark:via-neutral-950 dark:to-indigo-950",children:e.jsx(p,{items:_,variant:r,tone:o,corner:a,padding:u,size:x,indicator:v,indicatorPlacement:j,multiple:h,animated:w,disabled:S,loading:k,openIds:N.openIds,onChange:N.setOpenIds,glassOpacity:P,vibrancy:C,specularMode:I,ariaLabel:"Cloud regions"})})})})},de=[{id:"region-us",title:"United States",subtitle:"us-east-1 · N. Virginia",description:"Low latency for east coast workloads.",badge:"Primary",content:e.jsxs("div",{className:"space-y-2",children:[e.jsxs("p",{children:["Availability zones: ",e.jsx("strong",{children:"3"})]}),e.jsx("p",{children:"Average latency: 22 ms"}),e.jsxs("ul",{className:"list-disc pl-5",children:[e.jsx("li",{children:"GPU instances available"}),e.jsx("li",{children:"Supports spot capacity"})]})]})},{id:"region-eu",title:"Europe",subtitle:"eu-central-1 · Frankfurt",description:"Ideal for GDPR-compliant workloads.",badge:"High demand",content:e.jsxs("div",{className:"space-y-2",children:[e.jsx("p",{children:"Availability zones: 2"}),e.jsx("p",{children:"Average latency: 39 ms"}),e.jsx("p",{children:"Maintenance window: Sundays 02:00–04:00 CET"})]})},{id:"region-apac",title:"Asia Pacific",subtitle:"ap-southeast-1 · Singapore",description:"Great for APAC users and low-latency APIs.",content:e.jsxs("div",{className:"space-y-2",children:[e.jsx("p",{children:"Availability zones: 3"}),e.jsx("p",{children:"Average latency: 55 ms"}),e.jsx("p",{children:"Dedicated bare-metal hosts available on request."})]})}];function ce(){const[r,c]=t.useState([]),o=O({defaultOpenIds:["region-us"],multiple:!0}),g=a=>{c(d=>[...d,a]),setTimeout(()=>{c(d=>d.filter(u=>u!==a))},1500)};return e.jsx(p,{tone:"blue",size:"sm",items:de.map(a=>({...a,icon:"Globe",content:a.content,actions:a.id==="region-us"?e.jsx(T,{size:"xs",variant:"ghost",color:"blue",onClick:()=>g(a.id),children:"Refresh"}):void 0,loading:r.includes(a.id)})),openIds:o.openIds,onChange:o.setOpenIds,ariaLabel:"Cloud regions"})}const ue=`import { useState } from "react";
