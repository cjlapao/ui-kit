import{bs as R,j as e,a7 as c,P as _,a5 as B,k as T,bt as D,bu as L,r as o}from"./index-BBK6HA-D.js";import{P as I}from"./PageHeader-BcBcU29I.js";import{E as A}from"./ExampleCard-BVwGIEPO.js";import{P as z,C as H,S,a as O,T as P}from"./ControlAccordion-DallGojj.js";import{n as V,t as K,d as W}from"./options-D-FMIizr.js";const G=["skeleton","spinner","progress"],E="animate-pulse bg-black/10 motion-reduce:animate-none dark:bg-white/10",F={xs:{title:"text-xs",subtitle:"text-[10px]",counter:"text-[10px]",pad:"px-3 py-2",icon:"xs"},sm:{title:"text-xs",subtitle:"text-[11px]",counter:"text-[11px]",pad:"px-3 py-2",icon:"xs"},md:{title:"text-sm",subtitle:"text-xs",counter:"text-[11px]",pad:"px-4 py-3",icon:"sm"},lg:{title:"text-base",subtitle:"text-sm",counter:"text-xs",pad:"px-5 py-3.5",icon:"md"},xl:{title:"text-lg",subtitle:"text-base",counter:"text-sm",pad:"px-6 py-4",icon:"md"}},Z=({pages:t,resolvedTitle:i,subtitle:p,error:j,emptyState:b,emptyMessage:y,tone:n,size:g,current:r,total:x,loading:u,loaderType:m,progress:v,loadingLabel:N,loadingState:f,onPrev:w,onNext:h})=>{const l=B(),s=F[g]??F.md,d=x>1,a=i!=null||p!=null||d;return e.jsxs(e.Fragment,{children:[a&&e.jsxs("div",{className:c("flex items-center gap-2 border-b",s.pad,l.divider),children:[e.jsx("div",{className:"shrink-0",children:d&&e.jsx(T,{icon:"ArrowChevronLeft",variant:"ghost",color:n,size:s.icon,srLabel:"Previous page",tooltip:"Previous page",disabled:r===0,onClick:w})}),e.jsxs("div",{className:"flex-1 text-center min-w-0",children:[i!=null&&e.jsx("div",{className:c("font-semibold leading-snug truncate",s.title,l.heading),children:i}),p!=null&&e.jsx("div",{className:c("mt-0.5 truncate",s.subtitle,l.muted),children:p}),d&&e.jsxs("div",{role:"status","aria-live":"polite",className:c("mt-0.5 tabular-nums",s.counter,l.muted),children:[r+1," / ",x]})]}),e.jsx("div",{className:"shrink-0",children:d&&e.jsx(T,{icon:"ArrowChevronRight",variant:"ghost",color:n,size:s.icon,srLabel:"Next page",tooltip:"Next page",disabled:r===x-1,onClick:h})})]}),e.jsx("div",{className:"h-full w-full p-4 flex items-center justify-center",children:u?f??(m==="skeleton"?e.jsxs("div",{className:"flex w-full flex-col gap-3","aria-hidden":"true",children:[e.jsx("div",{className:c(E,"h-3 w-3/4 rounded")}),e.jsx("div",{className:c(E,"h-3 w-full rounded")}),e.jsx("div",{className:c(E,"h-3 w-5/6 rounded")})]}):e.jsx(D,{variant:m,size:g==="xs"||g==="sm"?"sm":"md",color:n,progress:v,label:N})):j?e.jsx(L,{variant:"plain",icon:"Error",iconColor:"rose",title:"Something went wrong",subtitle:j,showIcon:!0}):x===0&&!u?b??e.jsx(L,{variant:"plain",icon:"Info",title:y,showIcon:!0,tone:n}):t[r]})]})},k=({pages:t,title:i,subtitle:p,error:j,emptyState:b,emptyMessage:y="No data available.",tone:n="blue",size:g="md",page:r,onPageChange:x,bare:u=!1,loading:m=!1,loaderType:v="skeleton",progress:N,loadingLabel:f,loadingState:w,...h})=>{const l=R({count:t.length,page:r,onPageChange:x}),{page:s,total:d}=l,a=Array.isArray(i)?i[s]:i,C=e.jsx(Z,{pages:t,resolvedTitle:a,subtitle:p,error:j,emptyState:b,emptyMessage:y,tone:n,size:g,current:s,total:d,loading:m,loaderType:v,progress:N,loadingLabel:f,loadingState:w,onPrev:l.prev,onNext:l.next});return u?e.jsx("div",{className:c("relative overflow-hidden",h.className),children:C}):e.jsx(_,{...h,tone:n,padding:"none",bodyClassName:d===0&&!m?"h-full":"",className:c("relative overflow-hidden",h.className),children:C})},$=[e.jsx("p",{className:"text-sm",children:"First page — eu-west-1"},"1"),e.jsx("p",{className:"text-sm",children:"Second page — us-east-1"},"2"),e.jsx("p",{className:"text-sm",children:"Third page — ap-south-1"},"3")],q=()=>{const[t,i]=o.useState("md"),[p,j]=o.useState("blue"),[b,y]=o.useState("elevated"),[n,g]=o.useState(!1),[r,x]=o.useState(!1),[u,m]=o.useState(!1),[v,N]=o.useState(!1),[f,w]=o.useState("skeleton"),[h,l]=o.useState(!1),[s,d]=o.useState(!1);return e.jsx(z,{controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(H,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(S,{label:"Size",options:V,value:t,onChange:a=>i(a)}),e.jsx(S,{label:"Tone",options:K,value:p,onChange:a=>j(a)}),e.jsx(S,{label:"Variant",options:W,value:b,onChange:y})]})},{id:"content",title:"Content",controls:e.jsx(O,{label:"Header",children:e.jsxs("div",{className:"space-y-1.5",children:[e.jsx(P,{label:"Per-page titles",checked:n,onChange:g}),e.jsx(P,{label:"Subtitle",checked:r,onChange:x}),e.jsx(P,{label:"Bare (no Panel)",checked:s,onChange:d})]})})},{id:"states",title:"States",controls:e.jsxs(e.Fragment,{children:[e.jsx(S,{label:"Loader",options:G.map(a=>({label:a,value:a})),value:f,onChange:a=>w(a)}),e.jsx(O,{label:"State",children:e.jsxs("div",{className:"space-y-1.5",children:[e.jsx(P,{label:"Loading",checked:v,onChange:N}),e.jsx(P,{label:"No pages",checked:u,onChange:m}),e.jsx(P,{label:"Error",checked:h,onChange:l})]})})]})}]}),e.jsxs("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:["The position counter is a polite live region, so paging announces the new position — it used to swap the content silently. The nav is",e.jsx("code",{children:"IconButton"}),", so it takes the panel's tone and the kit's focus ring."]})]}),preview:e.jsx("div",{className:"w-full max-w-md",children:e.jsx(k,{pages:u?[]:$,title:n?["First","Second","Third"]:"Regions",subtitle:r?"rolling deploy":void 0,error:h?"Could not reach the registry":void 0,loading:v,loaderType:f,progress:40,size:t,tone:p,variant:b,bare:s})})})},J=[e.jsx("p",{className:"text-sm",children:"eu-west-1"},"1")];function M(){return e.jsx("div",{className:"grid w-full gap-4 sm:grid-cols-3",children:G.map(t=>e.jsx(k,{pages:J,title:t,loading:!0,loaderType:t,progress:40,loadingLabel:t==="progress"?"40%":void 0},t))})}const Q=`import { PagedPanel, PAGED_PANEL_LOADERS } from "@cjlapao/ui-kit";
