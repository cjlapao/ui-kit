...
`,ge=[{id:"a",title:"Draft"},{id:"b",title:"Review"},{id:"c",title:"Ship"}],me=()=>e.jsx("div",{className:"grid w-full grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3",children:K.map(s=>e.jsx(r,{steps:ge,tone:s,size:"xs",variant:"outlined",padding:"sm",defaultCurrentIndex:1,completedStepIds:["a"],interactive:!1},s))}),fe=`import { Stepper, TRUE_COLORS } from "@cjlapao/ui-kit";
