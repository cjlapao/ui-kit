import{r as s,j as e,l as a,M as d,z as O,p as B,m as A}from"./index-CASQDqc_.js";import{P as D}from"./PageHeader-DxnWpf-v.js";import{E as i}from"./ExampleCard-D_CxWJdb.js";import{P,S as v,C as p,T as c}from"./PlaygroundPanel-B62eNAMn.js";import{C as U}from"./ControlAccordion-BafxVZvc.js";import{r as _,n as V,t as M,D as G,j as H}from"./options-D2wLByKW.js";const W=({children:n})=>e.jsx("span",{className:"text-[11px] font-semibold uppercase tracking-wide opacity-60",children:n}),Z=()=>{const[n,t]=s.useState("icon"),[x,w]=s.useState("md"),[u,N]=s.useState("blue"),[m,C]=s.useState("full"),[h,k]=s.useState(!1),[g,y]=s.useState(!1),[f,z]=s.useState(!1),[r,L]=s.useState(!1),[b,T]=s.useState(!1),[S,R]=s.useState("none"),[E,I]=s.useState(0);return e.jsx(P,{controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(U,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(v,{label:"Variant",options:_,value:n,onChange:l=>t(l)}),e.jsx(p,{label:"Size",children:e.jsx(d,{fullWidth:!0,size:"sm",options:V,value:x,onChange:l=>w(l)})}),e.jsx(v,{label:"Tone",options:M,value:u,onChange:l=>N(l)}),e.jsx(p,{label:"Rounded",children:e.jsx(d,{fullWidth:!0,size:"sm",options:G,value:m,onChange:l=>C(l)})})]})},{id:"states",title:"States",controls:e.jsxs("div",{className:"grid grid-cols-2 gap-2",children:[e.jsx(c,{label:"Loading",checked:h,onChange:k}),e.jsx(c,{label:"Disabled",checked:g,onChange:y}),e.jsx(c,{label:"Accent",checked:f,onChange:z}),e.jsx(c,{label:"Glass",checked:r,onChange:L}),e.jsx(c,{label:"Tooltip",checked:b,onChange:T})]})},...r?[{id:"glass",title:"Glass",controls:e.jsx(p,{label:"Specular",children:e.jsx(d,{fullWidth:!0,size:"sm",options:H,value:S,onChange:l=>R(l)})})}]:[]]}),e.jsxs("p",{className:"text-xs opacity-70",children:["Icon buttons carry no text — the ",e.jsx("strong",{children:"srLabel"})," is what gets announced and doubles as the native title. Loading swaps the glyph for a spinner and blocks clicks."]})]}),preview:e.jsxs("div",{className:"flex w-full flex-col gap-3",children:[e.jsx("div",{className:"rounded-lg border border-neutral-200 bg-neutral-50 p-6 dark:border-neutral-700 dark:bg-neutral-900",children:e.jsx(a,{icon:"Send",variant:n,color:u,size:x,rounded:m,loading:h,disabled:g,accent:f,glass:r,specularMode:r?S:"none",tooltip:b?"Send message":void 0,tooltipPosition:"top",srLabel:"Send",onClick:()=>I(l=>l+1)})}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx(W,{children:"Clicks"}),e.jsx("code",{className:"rounded-lg bg-black/5 px-3 py-2 text-xs dark:bg-white/10",children:E})]})]})})},$=()=>e.jsx("div",{className:"grid w-full gap-3 sm:grid-cols-2",children:O.map(n=>e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(a,{icon:"Send",variant:n,color:"blue",size:"md",srLabel:n}),e.jsx("span",{className:"text-sm opacity-70",children:n})]},n))}),q=`import { BUTTON_VARIANTS, IconButton } from "@cjlapao/ui-kit";
