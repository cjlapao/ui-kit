...
`,$=[{id:"founder",label:"Founder & CEO",description:"Amy Elsner",children:[{id:"product",label:"Product Lead",description:"Asiya Javayant",children:[{id:"ux",label:"UX Designer",description:"Anna Fali"},{id:"pm",label:"Product Manager",description:"Bernardo Dominic"}]},{id:"engineering",label:"Engineering Lead",description:"Onyama Limba",children:[{id:"fe",label:"Frontend Engineer",description:"Elwin Sharvill"},{id:"be",label:"Backend Engineer",description:"Stephen Shaw"}]}]}],T=n=>n.split(" ").map(l=>l.charAt(0)).join("").slice(0,2).toUpperCase();function _(){return e.jsx(o,{nodes:$,ariaLabel:"Company",renderNode:({node:n})=>e.jsxs("div",{className:"flex items-center gap-2.5",children:[e.jsx("span",{className:"grid h-8 w-8 shrink-0 place-items-center rounded-full bg-neutral-200 text-xs font-semibold text-neutral-600 dark:bg-neutral-700 dark:text-neutral-200",children:T(n.description??n.label)}),e.jsxs("span",{className:"flex flex-col",children:[e.jsx("span",{className:"text-sm font-medium text-neutral-800 dark:text-neutral-100",children:n.label}),e.jsx("span",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:n.description})]})]})})}const H=`import { OrganizationChart, type OrgChartNode } from "@cjlapao/ui-kit";
...
`,W=[{id:"founder",label:"Founder",icon:"User",children:[{id:"product",label:"Product Lead",icon:"Users",children:[{id:"ux",label:"UX/UI Designer",icon:"Image"},{id:"pm",label:"Product Manager",icon:"Rocket"}]},{id:"engineering",label:"Engineering Lead",icon:"Users",children:[{id:"frontend",label:"Frontend Developer",icon:"Script"},{id:"backend",label:"Backend Developer",icon:"Log"}]}]}];function Z(){const[n,l]=a.useState([]);return e.jsxs("div",{className:"flex w-full flex-col gap-3",children:[e.jsx(o,{nodes:W,selectionMode:"multiple",selectedIds:n,onSelectionChange:l,ariaLabel:"Company"}),e.jsxs("p",{className:"text-xs text-neutral-400 dark:text-neutral-500",children:["Selected"," ",e.jsx("span",{className:"font-medium text-neutral-600 dark:text-neutral-300",children:n.length})," ","node",n.length===1?"":"s"," — click to add or remove."]})]})}const q=`import { useState } from "react";
import { OrganizationChart, type OrgChartNode } from "@cjlapao/ui-kit";
...
`,K=[{id:"founder",label:"Founder",icon:"User",children:[{id:"product",label:"Product Lead",icon:"Users",children:[{id:"ux",label:"UX/UI Designer",icon:"Image"},{id:"pm",label:"Product Manager",icon:"Rocket"}]},{id:"engineering",label:"Engineering Lead",icon:"Users",children:[{id:"frontend",label:"Frontend Developer",icon:"Script"},{id:"backend",label:"Backend Developer",icon:"Log"}]}]}];function Q(){const[n,l]=a.useState(["ux"]);return e.jsxs("div",{className:"flex w-full flex-col gap-3",children:[e.jsx(o,{nodes:K,selectionMode:"checkbox",selectedIds:n,onSelectionChange:l,ariaLabel:"Company"}),e.jsxs("p",{className:"text-xs text-neutral-400 dark:text-neutral-500",children:["Checked"," ",e.jsx("span",{className:"font-medium text-neutral-600 dark:text-neutral-300",children:n.length})," ","node",n.length===1?"":"s"," — checking a lead cascades to the whole branch, and ancestors show the partial state."]})]})}const Y=`import { useState } from "react";
import { OrganizationChart, type OrgChartNode } from "@cjlapao/ui-kit";
