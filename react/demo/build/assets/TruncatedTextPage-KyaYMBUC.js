import{r as o,j as e,bk as n}from"./index-BBK6HA-D.js";import{P as u}from"./PageHeader-BcBcU29I.js";import{E as p}from"./ExampleCard-BVwGIEPO.js";import{P as x,C as h,S as l,a as b}from"./ControlAccordion-DallGojj.js";const f="sha256:9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08 — a digest long enough to need truncating",m=["div","span","p"].map(t=>({label:t,value:t})),g=["top","bottom"].map(t=>({label:t,value:t})),j=()=>{const[t,i]=o.useState("div"),[s,d]=o.useState("top"),[r,c]=o.useState(280);return e.jsx(x,{controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(h,{groups:[{id:"options",title:"Options",controls:e.jsxs(e.Fragment,{children:[e.jsx(l,{label:"Element",options:m,value:t,onChange:a=>i(a)}),e.jsx(l,{label:"Tooltip side",options:g,value:s,onChange:a=>d(a)}),e.jsx(b,{label:"Container width",children:e.jsx("input",{type:"range",min:120,max:600,value:r,className:"w-full",onChange:a=>c(Number(a.target.value))})})]})}]}),e.jsxs("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:["Widen the container until the ellipsis disappears — the tooltip and the tab stop go with it. The element is focusable"," ",e.jsx("strong",{children:"only while actually truncated"}),", so a page of short labels gains no dead tab stops. Try tabbing to it."]})]}),preview:e.jsx("div",{style:{width:r},className:"rounded-lg border border-neutral-200 p-3 dark:border-neutral-700",children:e.jsx(n,{text:f,as:t,tooltipPosition:s,delay:300})})})};function T(){return e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsx("div",{className:"w-64 rounded-lg border border-neutral-200 p-3 dark:border-neutral-700",children:e.jsx(n,{text:"This label is far too long to fit inside its container",delay:300})}),e.jsx("div",{className:"w-64 rounded-lg border border-neutral-200 p-3 dark:border-neutral-700",children:e.jsx(n,{text:"Short enough",delay:300})})]})}const w=`import { TruncatedText } from "@cjlapao/ui-kit";
