import{r as a,j as e,b3 as l,M as o,e as d}from"./index-BBK6HA-D.js";import{P as E}from"./PageHeader-BcBcU29I.js";import{E as i}from"./ExampleCard-BVwGIEPO.js";import{P as A,C as L,a as c,S as D,T as p}from"./ControlAccordion-DallGojj.js";import{aK as M,t as P}from"./options-D-FMIizr.js";const V=[1,2,3,4,5].map(t=>({label:String(t),value:String(t)})),z=[1,2,3].map(t=>({label:String(t),value:String(t)})),B=[{label:"Off",value:"0"},{label:"1s",value:"1000"},{label:"2s",value:"2000"},{label:"3s",value:"3000"}],T=Array.from({length:8},(t,n)=>`Slide ${n+1}`),O=()=>{const[t,n]=a.useState(1),[r,u]=a.useState(1),[m,v]=a.useState("horizontal"),[x,j]=a.useState("blue"),[h,y]=a.useState(!1),[g,k]=a.useState(0),[f,C]=a.useState(!0),[b,w]=a.useState(!0),N=(s,I)=>e.jsx("div",{className:"flex h-56 items-center justify-center rounded-xl bg-neutral-100 text-sm font-medium text-neutral-500 dark:bg-neutral-800 dark:text-neutral-400",children:s},I);return e.jsx(A,{controls:e.jsx(L,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(c,{label:"Items visible",children:e.jsx(o,{fullWidth:!0,size:"sm",options:V,value:String(t),onChange:s=>n(Number(s))})}),e.jsx(c,{label:"Items per scroll",children:e.jsx(o,{fullWidth:!0,size:"sm",options:z,value:String(r),onChange:s=>u(Number(s))})}),e.jsx(c,{label:"Orientation",children:e.jsx(o,{fullWidth:!0,size:"sm",options:M,value:m,onChange:s=>v(s)})}),e.jsx(c,{label:"Autoplay",children:e.jsx(o,{fullWidth:!0,size:"sm",options:B,value:String(g),onChange:s=>k(Number(s))})}),e.jsx(D,{label:"Color",options:P,value:x,onChange:s=>j(s)})]})},{id:"states",title:"States",controls:e.jsxs(e.Fragment,{children:[e.jsx(p,{label:"Circular",checked:h,onChange:y}),e.jsx(p,{label:"Show navigators",checked:f,onChange:C}),e.jsx(p,{label:"Show indicators",checked:b,onChange:w})]})}]}),preview:e.jsx(l,{numVisible:t,numScroll:r,orientation:m,color:x,circular:h,autoplayInterval:g,showNavigators:f,showIndicators:b,viewportHeight:m==="vertical"?"320px":void 0,items:T.map(N)})})},F=["First slide","Second slide","Third slide","Fourth slide","Fifth slide"],W=()=>e.jsx(l,{items:F.map((t,n)=>e.jsx("div",{className:"flex h-48 items-center justify-center rounded-xl bg-neutral-100 text-sm font-medium text-neutral-500 dark:bg-neutral-800 dark:text-neutral-400",children:t},n))}),$=`import { Carousel } from "@cjlapao/ui-kit";
