import{r as t,j as e,V as x,bA as r}from"./index-BBK6HA-D.js";import{P as h}from"./PageHeader-BcBcU29I.js";import{E as g}from"./ExampleCard-BVwGIEPO.js";import{P as k,C as w,S as i,a as y,T as p}from"./ControlAccordion-DallGojj.js";import{t as S}from"./options-D-FMIizr.js";const E=[{id:"app",label:"Environment",tone:"violet",variables:[{key:"REGION",value:"eu-west-1"},{key:"EMPTY",value:""},{key:"SECRET",value:"s3cr3t",secret:!0}]}],j=["token","value"].map(a=>({label:a,value:a})),P=()=>{const[a,u]=t.useState("blue"),[s,c]=t.useState("token"),[o,m]=t.useState(!0),[l,v]=t.useState(!0);return e.jsx(k,{controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(w,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(i,{label:"Tone",options:S,value:a,onChange:n=>u(n)}),e.jsx(i,{label:"Opens in",options:j,value:s,onChange:n=>c(n)})]})},{id:"behaviour",title:"Behaviour",controls:e.jsx(y,{label:"Behaviour",children:e.jsxs("div",{className:"space-y-1.5",children:[e.jsx(p,{label:"Flag unresolvable",checked:o,onChange:m}),e.jsx(p,{label:"Always show toggle",checked:l,onChange:v})]})})}]}),e.jsxs("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:["Press the eye to switch between the token and what it resolves to. Note the three outcomes: a resolved value, a declared-but-"," ",e.jsx("strong",{children:"empty"})," one, and a token that does not exist at all — they render distinctly, where they used to look identical. A secret is masked rather than printed."]})]}),preview:e.jsx("div",{className:"max-w-lg text-sm",children:e.jsx(x,{value:"region {{env::app::REGION}}, empty {{env::app::EMPTY}}, secret {{var::app::SECRET}}, unknown {{env::app::NOPE}}",groups:E,defaultViewMode:s,flagMissing:o,alwaysShowToggle:l,tone:a},s)})})},d=[{id:"app",label:"Environment",tone:"violet",variables:[{key:"REGION",value:"eu-west-1"},{key:"EMPTY",value:""}]}];function f(){return e.jsxs("div",{className:"flex flex-col gap-3 text-sm",children:[e.jsxs("div",{children:[e.jsx("span",{className:"mr-2 text-xs uppercase tracking-wide opacity-60",children:"tokens"}),e.jsx(r,{value:"{{env::app::REGION}} {{env::app::EMPTY}} {{env::app::NOPE}}",groups:d,mode:"token"})]}),e.jsxs("div",{children:[e.jsx("span",{className:"mr-2 text-xs uppercase tracking-wide opacity-60",children:"values"}),e.jsx(r,{value:"{{env::app::REGION}} {{env::app::EMPTY}} {{env::app::NOPE}}",groups:d,mode:"value"})]})]})}const N=`import { SmartValueParts } from "@cjlapao/ui-kit";
...
`,V=()=>e.jsxs("div",{className:"mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-8 sm:px-8",children:[e.jsx(h,{name:"Smart Value",description:"The read-only twin of SmartInput: a value's tokens rendered as badges, with a toggle between the token and what it resolves to. Both render through SmartValueParts, so they cannot drift."}),e.jsx(P,{}),e.jsxs("section",{className:"flex flex-col gap-5",children:[e.jsx("h2",{className:"text-xs font-semibold uppercase tracking-widest text-neutral-400 dark:text-neutral-500",children:"Examples"}),e.jsx(g,{title:"Resolution states",description:"A resolved value, a declared-but-empty one, and a token that does not exist. The last two used to render identically, so a typo looked the same as an unset default.",code:N,filename:"States.tsx",children:e.jsx(f,{})})]})]});export{V as SmartValuePage,V as default};
