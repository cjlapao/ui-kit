...
`,Y=[{id:"a",label:"api-gateway",subtitle:"eu-west-1",icon:"Container",panel:e.jsx("div",{className:"p-4 text-sm",children:"Gateway detail"})},{id:"b",label:"worker-pool",subtitle:"us-east-1",icon:"Container",panel:e.jsx("div",{className:"p-4 text-sm",children:"Worker detail"})}];function Z(){return e.jsx("div",{className:"grid w-full gap-4 lg:grid-cols-2",children:H.map(a=>e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("span",{className:"text-xs uppercase tracking-wide text-neutral-400",children:a}),e.jsx("div",{className:"h-56 overflow-hidden rounded-lg",children:e.jsx(r,{items:Y,variant:a,tone:"blue",listTitle:"Capsules"})})]},a))})}const ee=`import { SplitView, SPLIT_VIEW_VARIANTS } from "@cjlapao/ui-kit";
