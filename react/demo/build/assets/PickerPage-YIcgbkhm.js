import{r as a,j as e,L as n,I as k,J as A}from"./index-BBK6HA-D.js";import{P as z}from"./PageHeader-BcBcU29I.js";import{E as m}from"./ExampleCard-BVwGIEPO.js";import{P as L,C as O,b as r,a as R,T as o}from"./ControlAccordion-DallGojj.js";import{x as B,t as D,n as _,a_ as F,K as G}from"./options-D-FMIizr.js";const U=[{id:"a",title:"api-gateway",subtitle:"eu-west-1",tags:[{label:"running"}]},{id:"b",title:"worker-pool",subtitle:"us-east-1",tags:[{label:"paused"}]},{id:"c",title:"batch-runner",subtitle:"ap-south-1",tags:[{label:"stopped"}]}],$=()=>{const[s,c]=a.useState("a"),[p,i]=a.useState([]),[l,I]=a.useState("blue"),[h,S]=a.useState("md"),[d,N]=a.useState("flat"),[u,y]=a.useState("none"),[x,T]=a.useState("soft"),[w,C]=a.useState(!1),[b,P]=a.useState(!1),[g,E]=a.useState(!1),[v,V]=a.useState(!1),[j,M]=a.useState(!0);return e.jsx(L,{controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(O,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(r,{label:"Variant",options:B,value:d,onChange:t=>N(t)}),e.jsx(r,{label:"Tone",options:D,value:l,onChange:t=>I(t)}),e.jsx(r,{label:"Size",options:_,value:h,onChange:t=>S(t)}),e.jsx(r,{label:"Validation",options:F,value:u,onChange:t=>y(t)})]})},...d==="gradient"?[{id:"glow",title:"Glow",controls:e.jsx(r,{label:"Glow",options:G,value:x,onChange:t=>T(t)})}]:[],{id:"behaviour",title:"Behaviour",controls:e.jsx(R,{label:"Behaviour",children:e.jsxs("div",{className:"space-y-1.5",children:[e.jsx(o,{label:"Multi-select",checked:w,onChange:C}),e.jsx(o,{label:"Default filter",checked:v,onChange:V}),e.jsx(o,{label:"Loading",checked:b,onChange:P}),e.jsx(o,{label:"Disabled",checked:g,onChange:E}),e.jsx(o,{label:"Compare with Input",checked:j,onChange:M})]})})}]}),e.jsxs("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:["The surface, padding, type scale and focus treatment all come from the shared field system in the theme — the same one"," ",e.jsx("code",{children:"Input"}),", ",e.jsx("code",{children:"Select"})," and ",e.jsx("code",{children:"SearchBar"})," ","use. Turn on ",e.jsx("strong",{children:"Compare with Input"})," and change the size: the two stay aligned, which they could not before, when this control had a two-entry size scale and a hardcoded white box."]})]}),preview:e.jsxs("div",{className:"flex w-full max-w-sm flex-col gap-3",children:[e.jsx(n,{items:U,tone:l,size:h,variant:d,validationStatus:u,glowIntensity:x,loading:b,disabled:g,multi:w,selectedId:s,onSelect:t=>c(t.id),selectedIds:p,onMultiChange:i,defaultFilter:v?{label:"Running",predicate:t=>t.tags?.[0]?.label==="running"}:void 0}),j&&e.jsx(k,{placeholder:"An Input, same size and variant",tone:l,size:h,variant:d,validationStatus:u,glowIntensity:x,disabled:g})]})})};function H(){const[s,c]=a.useState("a"),p=[{id:"a",title:"api-gateway"},{id:"b",title:"worker-pool"}];return e.jsx("div",{className:"grid w-full gap-4 sm:grid-cols-2",children:["red","green","blue","violet"].map(i=>e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"text-[11px] uppercase tracking-wide opacity-60",children:i}),e.jsx(n,{items:p,color:i,selectedId:s,onSelect:l=>c(l.id)})]},i))})}const J=`import { useState } from "react";
