import{r as a,j as e,B as t,M as f,d as h}from"./index-CASQDqc_.js";import{P as j}from"./PageHeader-DxnWpf-v.js";import{E as o}from"./ExampleCard-D_CxWJdb.js";import{P as g,S as v,C,T as c}from"./PlaygroundPanel-B62eNAMn.js";import{C as L}from"./ControlAccordion-BafxVZvc.js";import{t as w}from"./options-D2wLByKW.js";const B=[{label:"Chevron",value:"chevron"},{label:"Slash",value:"slash"},{label:"Dot",value:"dot"}],i=[{label:"Products",to:"/products"},{icon:"Cog",label:"Electronics",to:"/products/electronics"},{label:"Laptops",to:"/products/electronics/laptops"},{label:"Dell",current:!0}],E=()=>{const[r,u]=a.useState("blue"),[l,d]=a.useState("chevron"),[s,m]=a.useState(!0),[n,p]=a.useState(!1),b=n?[{icon:"Dots",to:"/products",ariaLabel:"Skipped items"},...i.slice(1)]:i;return e.jsx(g,{controls:e.jsx(L,{groups:[{id:"options",title:"Options",controls:e.jsxs(e.Fragment,{children:[e.jsx(v,{label:"Color",options:w,value:r,onChange:x=>u(x)}),e.jsx(C,{label:"Separator",children:e.jsx(f,{fullWidth:!0,size:"sm",options:B,value:l,onChange:d})}),e.jsxs("div",{className:"grid grid-cols-1 gap-2",children:[e.jsx(c,{label:"Home crumb",checked:s,onChange:m}),e.jsx(c,{label:"Ellipsis",checked:n,onChange:p})]})]})}]}),preview:e.jsx("div",{className:"flex w-full flex-col items-center gap-3",children:e.jsx(t,{color:r,separator:l==="slash"?"/":l==="dot"?"·":void 0,home:s?{icon:"Dashboard",to:"/",ariaLabel:"Home"}:void 0,items:b})})})};function D(){return e.jsx("div",{className:"flex w-full justify-center",children:e.jsx(t,{home:{icon:"Dashboard",to:"/",ariaLabel:"Home"},items:[{label:"Products",to:"/products"},{icon:"Cog",label:"Electronics",to:"/products/electronics"},{label:"Laptops",to:"/products/electronics/laptops"},{label:"Dell",current:!0}]})})}const y=`import { Breadcrumb } from "@cjlapao/ui-kit";
...
`;function S(){return e.jsx("div",{className:"flex w-full justify-center",children:e.jsx(t,{ariaLabel:"Docs breadcrumb",home:{icon:"UX",to:"/",ariaLabel:"Home"},items:[{label:"React docs",to:"/overview"},{label:"Breadcrumb",current:!0}]})})}const N=`import { Breadcrumb } from "@cjlapao/ui-kit";
...
`;function I(){return e.jsx("div",{className:"flex w-full justify-center",children:e.jsx(t,{home:{icon:"Dashboard",to:"/",ariaLabel:"Home",label:"Home"},items:[{label:"Products",to:"/products"},{icon:"Cog",label:"Electronics",to:"/products/electronics"},{icon:"ViewGrid",label:"Computers",to:"/products/computers"},{label:"Laptops",to:"/products/laptops",badge:e.jsx(h,{count:5,size:"xs"})},{label:"Dell",current:!0}]})})}const R=`import { Badge, Breadcrumb } from "@cjlapao/ui-kit";
