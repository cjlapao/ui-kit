import{r as a,j as e,c5 as o,M as N,m as k}from"./index-CASQDqc_.js";import{P as C}from"./PageHeader-DxnWpf-v.js";import{E as l}from"./ExampleCard-D_CxWJdb.js";import{P as w,S as s,T as S,C as E}from"./PlaygroundPanel-B62eNAMn.js";import{C as O}from"./ControlAccordion-BafxVZvc.js";import{d as H,t as P,n as B,p as M,bv as R,bw as z}from"./options-D2wLByKW.js";const L=["## Keyboard shortcuts","","Press **⌘K** for the command palette, or use these to move around:","","- `↑` / `↓` — move between rows","- `Enter` — open the focused item","- `Esc` — close this panel","","| Key | Action |","| --- | --- |","| `s` | Save draft |","| `p` | Publish |","","> Tip: every shortcut can be rebound under *Settings → Keyboard*."].join(`
