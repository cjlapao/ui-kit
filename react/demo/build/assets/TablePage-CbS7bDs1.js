import{r as s,j as e,$ as c,M as C,e as I}from"./index-BBK6HA-D.js";import{P as A}from"./PageHeader-BcBcU29I.js";import{E as u}from"./ExampleCard-BVwGIEPO.js";import{P as G,C as q,S as l,a as k,T as a}from"./ControlAccordion-DallGojj.js";import{d as V,t as N,V as J}from"./options-D-FMIizr.js";const R=[{id:"1",service:"api-gateway",owner:"platform",region:"eu-west",status:"healthy",uptime:99.99},{id:"2",service:"billing",owner:"payments",region:"eu-west",status:"degraded",uptime:98.21},{id:"3",service:"search",owner:"discovery",region:"us-east",status:"healthy",uptime:99.95},{id:"4",service:"notifications",owner:"comms",region:"us-east",status:"healthy",uptime:99.87},{id:"5",service:"auth",owner:"platform",region:"eu-west",status:"healthy",uptime:100}],Q=[{id:"service",header:"Service",accessor:"service",sortable:!0,groupable:!0},{id:"owner",header:"Owner",accessor:"owner",sortable:!0,groupable:!0},{id:"region",header:"Region",accessor:"region",sortable:!0},{id:"uptime",header:"Uptime",accessor:"uptime",sortable:!0,className:"text-right",render:t=>`${t.uptime.toFixed(2)}%`},{id:"status",header:"Status",accessor:"status",sortable:!0,render:t=>e.jsxs("span",{className:t.status==="healthy"?"inline-flex items-center gap-1.5 text-sm text-emerald-600 dark:text-emerald-400":"inline-flex items-center gap-1.5 text-sm text-amber-600 dark:text-amber-400",children:[e.jsx("span",{className:t.status==="healthy"?"h-1.5 w-1.5 rounded-full bg-emerald-500":"h-1.5 w-1.5 rounded-full bg-amber-500"}),t.status==="healthy"?"Healthy":"Degraded"]})}],X=()=>{const[t,r]=s.useState("outlined"),[o,T]=s.useState("neutral"),[d,O]=s.useState(""),[m,P]=s.useState("default"),[p,L]=s.useState(!1),[h,K]=s.useState(!0),[g,M]=s.useState(!0),[v,U]=s.useState(!0),[x,D]=s.useState(!0),[b,E]=s.useState(!0),[y,W]=s.useState(!0),[w,H]=s.useState(!1),[i,F]=s.useState("spinner"),[f,$]=s.useState(50),[S,z]=s.useState(!0),[j,B]=s.useState(null);return e.jsx(G,{controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(q,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(l,{label:"Surface (variant)",options:V,value:t,onChange:n=>r(n)}),e.jsx(l,{label:"Tone",options:N,value:o,onChange:n=>T(n)}),e.jsx(l,{label:"Control tone",options:[{label:"Follow tone",value:""},...N],value:d,onChange:O}),e.jsx(k,{label:"Density",children:e.jsx(C,{fullWidth:!0,size:"sm",options:J,value:m,onChange:n=>P(n)})})]})},{id:"loader",title:"Loader",controls:e.jsxs(e.Fragment,{children:[e.jsx(k,{label:"Loader (while loading)",children:e.jsx(C,{fullWidth:!0,size:"sm",options:[{label:"Spinner",value:"spinner"},{label:"Progress",value:"progress"},{label:"Skeleton",value:"skeleton"}],value:i,onChange:n=>F(n)})}),i==="progress"&&e.jsx(l,{label:"Progress",options:[{label:"25%",value:"25"},{label:"50%",value:"50"},{label:"75%",value:"75"}],value:String(f),onChange:n=>$(Number(n))})]})},{id:"options",title:"Options",controls:e.jsxs("div",{className:"grid grid-cols-1 gap-2",children:[e.jsx(a,{label:"Loading",checked:w,onChange:H}),e.jsx(a,{label:"Bordered grid",checked:p,onChange:L}),e.jsx(a,{label:"Striped rows",checked:h,onChange:K}),e.jsx(a,{label:"Row hover",checked:g,onChange:M}),e.jsx(a,{label:"Column selector",checked:v,onChange:U}),e.jsx(a,{label:"Group by",checked:x,onChange:D}),e.jsx(a,{label:"Sticky columns",checked:b,onChange:E}),e.jsx(a,{label:"Column resize",checked:y,onChange:W}),e.jsx(a,{label:"Persist settings",checked:S,onChange:z})]})}]}),e.jsxs("p",{className:"text-xs opacity-70",children:["Toggle ",e.jsx("code",{children:"Loading"})," to preview the three Panel-style loaders — the spinner/progress overlay stays pinned to the card while the content scrolls (the preview has a fixed height, so scroll it to check), and the skeleton replaces the rows with pulsing placeholders.",e.jsx("br",{}),"With ",e.jsx("code",{children:"storageKey"})," set, column visibility, column widths, group-by, pinned columns and the active view are written to"," ",e.jsx("code",{children:"localStorage"})," under"," ",e.jsx("code",{children:"ui-kit:table:playground"})," and restored on the next mount.",j?` Last save: ${JSON.stringify(j)}`:""]})]}),preview:e.jsx("div",{className:"w-full",children:e.jsx(c,{columns:Q,data:R,rowKey:n=>n.id,variant:t,tone:o,color:d||void 0,density:m,bordered:p,striped:h,hoverable:g,showColumnSelector:v,groupable:x,userStickyColumns:b,resizableColumns:y,showGroupHeader:!0,storageKey:S?"playground":void 0,onTableSettingsChange:B,maxHeight:420,loading:w,loadingMessage:"Loading services…",loaderType:i,loaderProgress:i==="progress"?f:void 0,footer:e.jsxs("span",{children:[R.length," services"]})})})})},Y=[{id:"1",name:"Builds",value:1284},{id:"2",name:"Deployments",value:312},{id:"3",name:"Rollbacks",value:9}],Z=[{id:"name",header:"Metric",accessor:"name"},{id:"value",header:"Count",accessor:"value",className:"text-right"}],_=["outlined","tonal","glass","liquid-glass"],ee=()=>e.jsx("div",{className:"flex flex-col gap-4 rounded-2xl bg-gradient-to-br from-sky-100 via-indigo-100 to-fuchsia-100 p-4 dark:from-slate-900 dark:via-indigo-950 dark:to-slate-900",style:{minHeight:320},children:e.jsx("div",{className:"grid gap-4 sm:grid-cols-2",children:_.map(t=>e.jsx(c,{columns:Z,data:Y,rowKey:r=>r.id,variant:t,tone:"blue",density:"compact",striped:!1,headerTitle:t,className:"min-w-0"},t))})}),te=`import React from "react";
