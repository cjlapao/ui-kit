import{r as s,j as e,M as r,b0 as a}from"./index-Bw7SVFgV.js";import{P as o}from"./PageHeader-CQm-NnZo.js";import{E as d}from"./ExampleCard-BR4461qP.js";import{C as c}from"./ChartPlayground-CJjSTqSp.js";import{g as n}from"./data-CdstPXM1.js";import"./PlaygroundPanel-efOYSasM.js";import"./ControlAccordion-BDKCdIsF.js";import"./options-CREM8uYu.js";function x(){const[l,i]=s.useState("candle");return e.jsxs("div",{className:"flex w-full max-w-4xl flex-col items-center gap-4",children:[e.jsx(r,{size:"sm",options:[{label:"Candles",value:"candle"},{label:"Hollow",value:"hollow"},{label:"OHLC bars",value:"ohlc"}],value:l,onChange:t=>i(t)}),e.jsxs(a.Svg,{height:340,children:[e.jsx(a.Title,{title:"Trading days",subtitle:"Mar → Jun 2025 · synthesized OHLC"}),e.jsx(a.Candlestick,{data:n,name:"Index",variant:l}),e.jsx(a.ReferenceLine,{y:150,label:"Target 150",color:"sky"}),e.jsx(a.Annotation,{x:n[10].date,y:n[10].high,tone:"emerald",title:"Earnings pop",value:"+4.2%"}),e.jsx(a.XAxis,{}),e.jsx(a.YAxis,{tickCount:5}),e.jsx(a.Tooltip,{mode:"shared",itemFormat:t=>t.toFixed(2)}),e.jsx(a.Hover,{})]})]})}const h=`import { useState } from "react";
