...
`,Ee=()=>e.jsx("div",{className:"grid w-full gap-3 md:grid-cols-2 xl:grid-cols-3",children:ce.map(a=>e.jsx(i,{variant:a,tone:"blue",size:"xs",icon:"Add",title:a,actionLabel:"Create",onAction:()=>{},fullWidth:!0},a))}),Te=`import { EMPTY_STATE_VARIANTS, EmptyState } from "@cjlapao/ui-kit";
