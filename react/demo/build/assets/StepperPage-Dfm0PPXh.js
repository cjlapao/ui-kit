import{r as n,j as e,bV as r,e as R,M as l,l as K}from"./index-p9Bv1Pn1.js";import{P as Q}from"./PageHeader-DCZtzAyX.js";import{E as d}from"./ExampleCard-BS13YSEO.js";import{P as X,S as c,C as i,T as o}from"./PlaygroundPanel-BDClNSzf.js";import{C as Y}from"./ControlAccordion-CydkdljU.js";import{d as Z,t as ee,n as te,bk as ne,bl as se,bm as oe,bn as ae,bo as le,bp as ie}from"./options-Bqu3_N-h.js";const p=[{id:"plan",title:"Plan Changes",subtitle:"Resolve diffs",description:"Review the pending infrastructure changes."},{id:"apply",title:"Apply Changes",subtitle:"Run terraform apply",description:"Provision the resources."},{id:"verify",title:"Verify",subtitle:"Smoke tests",description:"Confirm the deployment is healthy."},{id:"complete",title:"Complete",description:"Notify stakeholders and archive the run."}],re=()=>{const[s,a]=n.useState("elevated"),[g,I]=n.useState("blue"),[f,z]=n.useState("md"),[v,L]=n.useState("horizontal"),[b,O]=n.useState("full"),[y,E]=n.useState("spinner"),[C,V]=n.useState("progress"),[j,A]=n.useState("center"),[S,D]=n.useState("bottom"),[w,W]=n.useState(!0),[k,B]=n.useState(!0),[N,$]=n.useState(!1),[P,M]=n.useState(!1),[T,U]=n.useState(!1),[u,_]=n.useState(!1),[h,F]=n.useState(!1),[G,x]=n.useState(1),[H,m]=n.useState(["plan"]),q=t=>{h||u||(x(t),m(p.slice(0,t).map(J=>J.id??"")))};return e.jsx(X,{previewClassName:"w-full",controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(Y,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(c,{label:"Variant",options:Z,value:s,onChange:t=>a(t)}),e.jsx(c,{label:"Tone",options:ee,value:g,onChange:t=>I(t)}),e.jsx(c,{label:"Size",options:te,value:f,onChange:t=>z(t)}),e.jsx(i,{label:"Orientation",children:e.jsx(l,{fullWidth:!0,size:"sm",options:ne,value:v,onChange:t=>L(t)})}),e.jsx(c,{label:"Node corner",options:se,value:b,onChange:t=>O(t)})]})},{id:"loader",title:"Loader",controls:e.jsx(i,{label:"Loader type",children:e.jsx(l,{fullWidth:!0,size:"sm",options:oe,value:y,onChange:t=>E(t)})})},{id:"layout",title:"Layout",controls:e.jsxs(e.Fragment,{children:[e.jsx(i,{label:"Connector",children:e.jsx(l,{fullWidth:!0,size:"sm",options:ae,value:C,onChange:t=>V(t)})}),e.jsx(i,{label:"Connector align",children:e.jsx(l,{fullWidth:!0,size:"sm",options:le,value:j,onChange:t=>A(t)})}),e.jsx(i,{label:"Progress bar position",children:e.jsx(l,{fullWidth:!0,size:"sm",options:ie,value:S,onChange:t=>D(t)})})]})},{id:"options",title:"Options",controls:e.jsxs("div",{className:"grid grid-cols-2 gap-2",children:[e.jsx(o,{label:"Interactive",checked:w,onChange:W}),e.jsx(o,{label:"Animated",checked:k,onChange:B}),e.jsx(o,{label:"Connect nodes",checked:N,onChange:$}),e.jsx(o,{label:"Progress bar",checked:P,onChange:M}),e.jsx(o,{label:"Progress summary",checked:T,onChange:U}),e.jsx(o,{label:"Loading",checked:u,onChange:_}),e.jsx(o,{label:"Disabled",checked:h,onChange:F})]})}]}),e.jsxs("p",{className:"text-xs opacity-70",children:[e.jsx("strong",{children:"Spinner"})," and ",e.jsx("strong",{children:"progress"})," overlay the node (and the Panel when the whole stepper loads);"," ",e.jsx("strong",{children:"skeleton"})," replaces the content with pulsing discs and lines. Click a step to complete every step before it."]})]}),preview:e.jsxs("div",{className:"flex w-full flex-col gap-4",children:[e.jsx(r,{steps:p,variant:s,tone:g,size:f,orientation:v,nodeCorner:b,connector:C,connectorAlign:j,progressBarPosition:S,connectNodes:N,interactive:w,animated:k,loaderType:y,disabled:h,currentIndex:G,completedStepIds:H,loading:u,showProgressBar:P,showProgressSummary:T,onChange:q}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx(R,{size:"sm",variant:"outline",onClick:()=>{x(0),m([])},children:"Reset"}),e.jsx(R,{size:"sm",variant:"outline",onClick:()=>{x(p.length-1),m(p.map(t=>t.id??""))},children:"Mark all complete"})]})]})})},de=()=>e.jsx(r,{steps:[{id:"plan",title:"Plan",subtitle:"Review the diff",description:"Nothing is touched yet — just the plan."},{id:"apply",title:"Apply",subtitle:"Run the migration",description:"3 tables · 2 indexes · 40k rows"},{id:"verify",title:"Verify",subtitle:"Smoke tests",description:"Confirm the target is healthy and logs are clean."}],orientation:"vertical",size:"sm",variant:"outlined",defaultCurrentIndex:1,completedStepIds:["plan"],interactive:!1}),ce=`import { Stepper } from "@cjlapao/ui-kit";
