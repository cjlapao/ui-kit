import{r as a,D as U,j as e,R as u,M as i,I as q}from"./index-BBK6HA-D.js";import{P as B}from"./PageHeader-BcBcU29I.js";import{E as c}from"./ExampleCard-BVwGIEPO.js";import{P as _,C as $,S as p,a as n,T as r}from"./ControlAccordion-DallGojj.js";import{L as J,t as Q,p as X,e as Y,x as Z,M as ee,j as ae,k as te,l as se}from"./options-D-FMIizr.js";const le=["glass","liquid-glass","default"],ne=[{key:"ENV",value:"production"},{key:"DEBUG",value:"false"},{key:"host",value:"localhost"},{key:"port",value:"27017"}],ie=()=>{const[s,l]=a.useState(ne),[o,d]=a.useState("outlined"),[h,V]=a.useState("blue"),[m,A]=a.useState(U),[x,E]=a.useState("sm"),[y,I]=a.useState("flat"),[v,K]=a.useState("sm"),[g,T]=a.useState("Add entry"),[f,F]=a.useState(!0),[b,D]=a.useState(!0),[j,L]=a.useState(!1),[k,O]=a.useState(!1),[w,R]=a.useState(!0),[C,z]=a.useState(!1),[S,H]=a.useState("classic"),[P,W]=a.useState("medium"),[N,G]=a.useState("frosted"),M=le.includes(o);return e.jsx(_,{controls:e.jsx($,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(p,{label:"Variant",options:J,value:o,onChange:t=>d(t)}),e.jsx(p,{label:"Tone",options:Q,value:h,onChange:t=>V(t)}),e.jsx(p,{label:"Corner",options:X,value:m,onChange:t=>A(t)}),e.jsx(n,{label:"Padding",children:e.jsx(i,{fullWidth:!0,size:"sm",options:Y,value:x,onChange:t=>E(t)})}),e.jsx(n,{label:"Input surface",children:e.jsx(i,{fullWidth:!0,size:"sm",options:Z,value:y,onChange:t=>I(t)})}),e.jsx(n,{label:"Size",children:e.jsx(i,{fullWidth:!0,size:"sm",options:ee,value:v,onChange:t=>K(t)})})]})},{id:"content",title:"Content",controls:e.jsxs(e.Fragment,{children:[e.jsx(n,{label:"Add button label",children:e.jsx(q,{size:"sm",value:g,onChange:t=>T(t.target.value)})}),e.jsxs("div",{className:"grid grid-cols-1 gap-2",children:[e.jsx(r,{label:"Hint",checked:f,onChange:F}),e.jsx(r,{label:"Help text",checked:b,onChange:D}),e.jsx(r,{label:"Error",checked:j,onChange:L}),e.jsx(r,{label:"Disabled",checked:k,onChange:O}),e.jsx(r,{label:"Flag duplicate keys",checked:w,onChange:R}),e.jsx(r,{label:"Cap at 5 rows",checked:C,onChange:z})]})]})},...M?[{id:"glass",title:"Glass",controls:e.jsxs(e.Fragment,{children:[e.jsx(n,{label:"Specular",children:e.jsx(i,{fullWidth:!0,size:"sm",options:ae,value:S,onChange:t=>H(t)})}),e.jsx(n,{label:"Vibrancy",children:e.jsx(i,{fullWidth:!0,size:"sm",options:te,value:P,onChange:t=>W(t)})}),e.jsx(n,{label:"Glass opacity",children:e.jsx(i,{fullWidth:!0,size:"sm",options:se,value:N,onChange:t=>G(t)})})]})}]:[]]}),preview:e.jsx("div",{className:"w-full",children:e.jsx("div",{className:"w-full rounded-lg bg-gradient-to-br from-indigo-100 via-neutral-50 to-rose-100 p-4 dark:from-slate-900 dark:via-neutral-950 dark:to-indigo-950",children:e.jsx(u,{label:"Metadata",hint:f?"Store extra settings via key/value pairs":void 0,help:b?"Use this field to supply extra environment variables or service metadata. Keys must be unique — a duplicate silently overwrites the earlier value once the map is serialised.":void 0,error:j?"At least one entry is required.":void 0,value:s,onChange:l,addLabel:g,variant:o,tone:h,corner:m,padding:x,inputVariant:y,size:v,disabled:k,flagDuplicateKeys:w,maxRows:C?5:void 0,glassOpacity:N,vibrancy:P,specularMode:S})})})})},re=[{key:"ENV",value:"production"},{key:"DEBUG",value:"false"},{key:"host",value:"localhost"},{key:"port",value:"27017"}];function oe(){const[s,l]=a.useState(re);return e.jsx("div",{className:"w-full",children:e.jsx(u,{label:"Metadata",hint:"Store extra settings via key/value pairs",help:"Use this field to supply extra environment variables or service metadata. Keys must be unique — a duplicate silently overwrites the earlier value once the map is serialised.",value:s,onChange:l,tone:"blue",variant:"outlined"})})}const ue=`import { useState } from "react";
