...
`;function W(){return e.jsx("div",{className:"flex w-full max-w-sm flex-col gap-3",children:E.map(n=>e.jsx(s,{label:n,children:e.jsx(l,{size:n,defaultValue:"hunter2"})},n))})}const Y=`import { CONTROL_SIZES, FormField, PasswordInput } from "@cjlapao/ui-kit";
