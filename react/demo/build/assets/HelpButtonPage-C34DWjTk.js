import{r as a,j as e,bS as o,M as N,l as k}from"./index-8i9ZNynb.js";import{P as C}from"./PageHeader-CO5k_SQv.js";import{E as l}from"./ExampleCard-LdxcpmX_.js";import{P as w,S as s,T as S,C as E}from"./PlaygroundPanel-Dv9BQ1Hr.js";import{C as O}from"./ControlAccordion-Bqp-1oBj.js";import{d as H,t as P,n as B,p as M,br as R,bs as z}from"./options-yAU-f7tt.js";const L=["## Keyboard shortcuts","","Press **⌘K** for the command palette, or use these to move around:","","- `↑` / `↓` — move between rows","- `Enter` — open the focused item","- `Esc` — close this panel","","| Key | Action |","| --- | --- |","| `s` | Save draft |","| `p` | Publish |","","> Tip: every shortcut can be rebound under *Settings → Keyboard*."].join(`
