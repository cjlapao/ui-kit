import{r as a,j as e,br as n,M as m,I as p,C as B,w as I}from"./index-CASQDqc_.js";import{P as w}from"./PageHeader-DxnWpf-v.js";import{E as s}from"./ExampleCard-D_CxWJdb.js";import{P as L,C as i,S as x,T as k}from"./PlaygroundPanel-B62eNAMn.js";import{C as T}from"./ControlAccordion-BafxVZvc.js";import{t as f}from"./options-D2wLByKW.js";const y=[{label:"Bell",value:"Notification"},{label:"Chat",value:"Chat"},{label:"Users",value:"Users"},{label:"Star",value:"Star"}],S=[{label:"Top start",value:"top-start"},{label:"Top end",value:"top-end"},{label:"Bottom start",value:"bottom-start"},{label:"Bottom end",value:"bottom-end"}],D=()=>{const[t,l]=a.useState("Notification"),[c,h]=a.useState("red"),[d,C]=a.useState("blue"),[u,v]=a.useState(5),[r,j]=a.useState(99),[b,N]=a.useState("top-end"),[g,P]=a.useState(!1);return e.jsx(L,{controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(T,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(i,{label:"Icon",children:e.jsx(m,{fullWidth:!0,size:"sm",options:y,value:t,onChange:o=>l(o)})}),e.jsx(x,{label:"Badge tone",options:f,value:c,onChange:o=>h(o)})]})},{id:"icons",title:"Icons",controls:e.jsx(x,{label:"Icon color",options:f,value:d,onChange:o=>C(o)})},{id:"content",title:"Content",controls:e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsx(i,{label:"Count",children:e.jsx(p,{size:"sm",type:"number",value:u,onChange:o=>v(Number(o.target.value))})}),e.jsx(i,{label:"Max count",children:e.jsx(p,{size:"sm",type:"number",value:r,onChange:o=>j(Number(o.target.value))})})]})},{id:"layout",title:"Layout",controls:e.jsx(i,{label:"Position",children:e.jsx(m,{fullWidth:!0,size:"sm",options:S,value:b,onChange:o=>N(o)})})},{id:"states",title:"States",controls:e.jsx(k,{label:"Dot only",checked:g,onChange:P})}]}),e.jsxs("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:["A count above max count renders as ",r,"+. A count of 0 hides the badge unless Dot only is on."]})]}),preview:e.jsx("div",{className:"flex h-40 w-40 items-center justify-center",children:e.jsx(n,{icon:t,srLabel:"Badge icon preview",color:d,badgeCount:u,badgeDot:g,badgePosition:b,badgeProps:{tone:c,maxCount:r}})})})};function O(){return e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx(n,{icon:"Notification",srLabel:"Notifications",color:"blue",badgeCount:5,badgeProps:{tone:"rose"}}),e.jsx(n,{icon:"Chat",srLabel:"Messages",color:"blue",badgeCount:12,badgeProps:{tone:"blue"}}),e.jsx(n,{icon:"Users",srLabel:"Team",color:"emerald",badgeDot:!0,badgeProps:{tone:"emerald"}}),e.jsx(n,{icon:"Search",srLabel:"Search",color:"neutral"})]})}const z=`import { BadgeIcon } from "@cjlapao/ui-kit";
