import{r as n,j as e,bF as o,aC as I,bG as P}from"./index-BBK6HA-D.js";import{P as z}from"./PageHeader-BcBcU29I.js";import{E as d}from"./ExampleCard-BVwGIEPO.js";import{P as K,C as O,S as r,a as _,T as a}from"./ControlAccordion-DallGojj.js";import{b4 as V,b5 as q,n as F,t as D,p as Y,e as B}from"./options-D-FMIizr.js";const M=()=>{const[t,i]=n.useState("unknown"),[u,w]=n.useState("outlined"),[p,v]=n.useState("md"),[l,k]=n.useState(""),[h,j]=n.useState("rounded-xl"),[g,S]=n.useState("lg"),[x,R]=n.useState(!0),[m,E]=n.useState(!1),[y,A]=n.useState(!0),[f,T]=n.useState(!0),[b,C]=n.useState(!0),[c,N]=n.useState(!0);return e.jsx(K,{controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(O,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(r,{label:"Kind",options:V,value:t,onChange:s=>i(s)}),e.jsx(r,{label:"Variant",options:q,value:u,onChange:s=>w(s)}),e.jsx(r,{label:"Size",options:F,value:p,onChange:s=>v(s)}),e.jsx(r,{label:"Tone override",options:[{label:"From the kind",value:""},...D],value:l,onChange:s=>k(s)}),e.jsx(r,{label:"Corner",options:Y,value:h,onChange:s=>j(s)}),e.jsx(r,{label:"Padding",options:B,value:g,onChange:s=>S(s)})]})},{id:"states",title:"States",controls:e.jsx(_,{label:"State",children:e.jsxs("div",{className:"space-y-1.5",children:[e.jsx(a,{label:"Retry button",checked:x,onChange:R}),e.jsx(a,{label:"Retrying",checked:m,onChange:E}),e.jsx(a,{label:"Dashed rule",checked:y,onChange:A}),e.jsx(a,{label:"Icon",checked:f,onChange:T}),e.jsx(a,{label:"Icon disc",checked:b,onChange:C}),e.jsx(a,{label:"Is error",checked:c,onChange:N})]})})}]}),e.jsxs("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:[e.jsx("strong",{children:"Kind"})," picks the tone, the glyph and the copy from one table — anything you state explicitly still wins, which is what the tone override shows. ",e.jsx("strong",{children:"Retrying"})," spins the button and blocks it, so a slow request cannot be fired twice."," ",e.jsx("strong",{children:"Is error"})," renders nothing at all, for a call site that would otherwise need a ternary."]})]}),preview:e.jsxs("div",{className:"w-full",children:[e.jsx(o,{kind:t,variant:u,size:p,tone:l===""?void 0:l,corner:h,padding:g,dashed:y,showIcon:f,iconBackground:b,isError:c,retrying:m,onRetry:x?()=>{}:void 0}),!c&&e.jsx("p",{className:"text-center text-xs text-neutral-500 dark:text-neutral-400",children:"Nothing rendered — `isError` is false."})]})})};function L(){return e.jsx("div",{className:"grid w-full gap-4 lg:grid-cols-2",children:I.map(t=>e.jsx(o,{kind:t,size:"sm",onRetry:t==="forbidden"||t==="notFound"?void 0:()=>{}},t))})}const W=`import { API_ERROR_KINDS, ApiErrorState } from "@cjlapao/ui-kit";
...
`;function J(){const[t,i]=n.useState(!1);return e.jsx(o,{kind:"server",retrying:t,buttonText:"Try again",onRetry:()=>{i(!0),setTimeout(()=>i(!1),2e3)}})}const Q=`import { useState } from "react";
