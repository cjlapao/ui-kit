import{r as t,j as e,bV as n,M as d,bi as C}from"./index-CASQDqc_.js";import{P as k}from"./PageHeader-DxnWpf-v.js";import{E as i}from"./ExampleCard-D_CxWJdb.js";import{P as z,C as m,S as h,T as u}from"./PlaygroundPanel-B62eNAMn.js";import{C as N}from"./ControlAccordion-BafxVZvc.js";import{n as P,bf as T,t as L}from"./options-D2wLByKW.js";const D=[{label:"Indeterminate",value:"indeterminate"},{label:"Determinate",value:"determinate"}],y=[0,25,50,62,75,100].map(a=>({label:`${a}%`,value:String(a)})),E=()=>{const[a,g]=t.useState("indeterminate"),[r,f]=t.useState("xl"),[o,S]=t.useState("normal"),[l,v]=t.useState("blue"),[x,w]=t.useState(62),[p,j]=t.useState(!0),[c,b]=t.useState(!1);return e.jsx(z,{controls:e.jsx(N,{groups:[{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(m,{label:"Mode",children:e.jsx(d,{fullWidth:!0,size:"sm",options:D,value:a,onChange:s=>g(s)})}),e.jsx(m,{label:"Size",children:e.jsx(d,{fullWidth:!0,size:"sm",options:P,value:r,onChange:s=>f(s)})}),e.jsx(m,{label:"Thickness",children:e.jsx(d,{fullWidth:!0,size:"sm",options:T,value:o,onChange:s=>S(s)})}),e.jsx(h,{label:"Color",options:L,value:l,onChange:s=>v(s)}),e.jsx(h,{label:"Value",options:y,value:String(x),onChange:s=>w(Number(s))})]})},{id:"states",title:"States",controls:e.jsxs(e.Fragment,{children:[e.jsx(u,{label:"Show value",checked:p,onChange:j}),e.jsx(u,{label:"Slow tempo",checked:c,onChange:b})]})}]}),preview:a==="determinate"?e.jsx(n,{value:x,size:r,thickness:o,color:l,showValue:p,animationDuration:c?"4s":"2s",ariaLabel:"Demo progress"}):e.jsx(n,{size:r,thickness:o,color:l,animationDuration:c?"4s":"2s",ariaLabel:"Demo progress"})})},V=()=>e.jsxs("div",{className:"flex flex-wrap items-center gap-4",children:[e.jsx(n,{}),e.jsx(n,{color:"emerald",ariaLabel:"Syncing"}),e.jsx(n,{color:"violet",size:"lg",ariaLabel:"Processing"}),e.jsx(n,{color:"amber",size:"xl",thickness:"thick",ariaLabel:"Uploading"})]}),I=`import { ProgressSpinner } from "@cjlapao/ui-kit";
...
`,O=()=>e.jsxs("div",{className:"flex flex-wrap items-center gap-4",children:[e.jsx(n,{value:25,size:"lg",ariaLabel:"Downloading"}),e.jsx(n,{value:50,size:"lg",color:"emerald",ariaLabel:"Downloading"}),e.jsx(n,{value:75,size:"lg",color:"violet",ariaLabel:"Downloading"}),e.jsx(n,{value:100,size:"lg",color:"amber",ariaLabel:"Downloading"})]}),W=`import { ProgressSpinner } from "@cjlapao/ui-kit";
...
`,_=()=>e.jsxs("div",{className:"mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-8 sm:px-8",children:[e.jsx(k,{name:"Progress Spinner",description:"A circular process status indicator — an animated ring when the work has no measurable end, a filled arc with a centre readout when it does. One component, two ARIA modes, on the shared control scale."}),e.jsx(E,{}),e.jsxs("section",{className:"flex flex-col gap-5",children:[e.jsx("h2",{className:"text-xs font-semibold uppercase tracking-widest text-neutral-400 dark:text-neutral-500",children:"Examples"}),e.jsx(i,{title:"Indeterminate",description:'Omit `value` for the classic chasing-arc animation. The ring reads as a status region announcing its `ariaLabel` (default "Loading"); the whole tempo is one prop — `animationDuration`.',code:I,filename:"Indeterminate.tsx",children:e.jsx(V,{})}),e.jsx(i,{title:"Determinate",description:"Pass a `value` and the ring becomes a filled arc with a centre percentage readout, announced through `aria-valuenow` and friends. The arc animates smoothly between values; `showValue={false}` hides the readout.",code:W,filename:"Determinate.tsx",children:e.jsx(O,{})}),e.jsx(i,{title:"Sizes",description:'The shared control scale — `xs` through `xl` — so a spinner lines up with the Button or Spinner next to it at every size. The stroke weight is kept in physical px, not viewBox units, so "normal" is the same thickness everywhere.',code:$,filename:"Sizes.tsx",children:e.jsx(Z,{})}),e.jsx(i,{title:"Tones",description:"Any of the 21 kit tones. The arc reads the tone's own CSS variable and the idle track is derived from it with `color-mix`, so a tone can never render as another colour.",code:R,filename:"Tones.tsx",children:e.jsx(F,{})}),e.jsx(i,{title:"Custom",description:"`min`/`max` for a range that is not 0-100, `thickness` for the ring weight, `animationDuration` for the tempo, and `showValue` for the readout.",code:G,filename:"Custom.tsx",children:e.jsx(B,{})}),e.jsx(i,{title:"With Stat Card",description:"The PrimeVue showcase, straight from the kit: a dark emerald `gradient` `StatCard` with a big white 100% value, and `progress` pinning a same-tone indeterminate spinner to the bottom-right corner — the title row rides its free-form slot on the same row. The dark wash is what lets the light arc read.",code:Q,filename:"WithStatCard.tsx",children:e.jsx(K,{})})]})]});export{_ as ProgressSpinnerPage,_ as default};
