...
`,K=[{value:"xs",label:"xs · 12px"},{value:"sm",label:"sm · 16px"},{value:"md",label:"md · 24px"},{value:"lg",label:"lg · 32px"},{value:"xl",label:"xl · 40px"}],L='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" fill="#2563eb"/></svg>',Y=()=>e.jsx("div",{className:"flex items-end gap-6",children:K.map(({value:l,label:o})=>e.jsxs("div",{className:"flex flex-col items-center gap-2",children:[e.jsx(t,{src:L,size:l,tone:"blue"}),e.jsx("span",{className:"text-[11px] opacity-60",children:o})]},l))}),Q=`import React from "react";
import { DynamicImg } from "@cjlapao/ui-kit";
...
`,m='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M4 12h16M12 4v16" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round"/></svg>',W='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="g" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#f43f5e"/><stop offset="1" stop-color="#8b5cf6"/></linearGradient></defs><rect x="2" y="2" width="20" height="20" rx="5" fill="url(#g)"/></svg>',$=[{label:"Tone: blue",note:"Recoloured to the theme colour.",img:e.jsx(t,{src:m,size:"xl",tone:"blue"})},{label:"Tone: violet",note:"A different theme colour.",img:e.jsx(t,{src:m,size:"xl",tone:"violet"})},{label:"Raw fill",note:"fill overrides the tone.",img:e.jsx(t,{src:m,size:"xl",fill:"#f43f5e",stroke:"#f43f5e"})},{label:"Raw stroke",note:"stroke paints only the outline.",img:e.jsx(t,{src:m,size:"xl",stroke:"#0ea5e9"})},{label:"Keep own colours",note:"colored preserves the gradient.",img:e.jsx(t,{src:W,size:"xl",tone:"blue",colored:!0})}],H=()=>e.jsx("div",{className:"grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5",children:$.map(l=>e.jsxs("div",{className:"flex flex-col items-center gap-2 text-center",children:[e.jsx("div",{className:"flex h-16 w-full items-center justify-center rounded-xl border border-neutral-200 dark:border-neutral-700",children:l.img}),e.jsx("span",{className:"text-xs font-semibold",children:l.label}),e.jsx("span",{className:"text-[11px] leading-snug opacity-60",children:l.note})]},l.label))}),q=`import React from "react";
import { DynamicImg } from "@cjlapao/ui-kit";
...
`,p='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" fill="#2563eb"/></svg>',Z=[{label:"Accessible name",note:'alt sets role="img" + aria-label.',img:e.jsx(t,{src:p,size:"lg",tone:"blue",alt:"Company logo"})},{label:"Decorative (no alt)",note:"Omitting alt hides it from assistive tech.",img:e.jsx(t,{src:p,size:"lg",tone:"blue"})},{label:"Tooltip",note:"title adds a native tooltip.",img:e.jsx(t,{src:p,size:"lg",tone:"blue",alt:"Company logo",title:"Company logo"})},{label:"Fallback icon",note:"Rejected markup renders the fallbackIcon.",img:e.jsx(t,{src:"<div>not an svg</div>",size:"lg",tone:"amber",fallbackIcon:"Image",alt:"Missing image"})}],J=()=>e.jsx("div",{className:"grid grid-cols-2 gap-4 sm:grid-cols-4",children:Z.map(l=>e.jsxs("div",{className:"flex flex-col items-center gap-2 text-center",children:[e.jsx("div",{className:"flex h-16 w-full items-center justify-center rounded-xl border border-neutral-200 dark:border-neutral-700",children:l.img}),e.jsx("span",{className:"text-xs font-semibold",children:l.label}),e.jsx("span",{className:"text-[11px] leading-snug opacity-60",children:l.note})]},l.label))}),_=`import React from "react";
import { DynamicImg } from "@cjlapao/ui-kit";
...
`,ie=()=>e.jsxs("div",{className:"mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-8 sm:px-8",children:[e.jsx(z,{name:"Dynamic Image",description:"Renders a data URL or raw SVG markup. SVG is sanitised against an allowlist before it is injected, then recoloured to follow the theme."}),e.jsx(P,{}),e.jsxs("section",{className:"flex flex-col gap-5",children:[e.jsx("h2",{className:"text-xs font-semibold uppercase tracking-widest text-neutral-400 dark:text-neutral-500",children:"Examples"}),e.jsx(d,{title:"Sanitised sources",description:"Seven sources at once: the fill and gradient follow the tone, the outline keeps its strokes, the raster renders in an inert img, the hostile SVG is stripped down to its safe path, and the non-image falls back to an icon.",code:U,filename:"SanitisedSources.tsx",children:e.jsx(O,{})}),e.jsx(d,{title:"Size ladder",description:"The same mark across the whole size scale — raster images respect it too.",code:Q,filename:"SizeLadder.tsx",children:e.jsx(Y,{})}),e.jsx(d,{title:"Recolouring",description:"Theme tone, raw fill, raw stroke, and colored to keep an SVG's own palette.",code:q,filename:"Recolouring.tsx",children:e.jsx(H,{})}),e.jsx(d,{title:"Accessibility",description:"alt makes it a named image, omitting alt marks it decorative, title adds a tooltip, and rejected markup renders the fallback icon.",code:_,filename:"Accessibility.tsx",children:e.jsx(J,{})})]})]});export{ie as DynamicImgPage,ie as default};
