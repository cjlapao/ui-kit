...
`,q=()=>e.jsx("div",{className:"flex w-full max-w-sm flex-col gap-3",children:O.map(n=>e.jsx(o,{size:n,leadingAddon:"https://",trailingAddon:n,children:e.jsx(t,{placeholder:"your-company"})},n))}),H=`import { CONTROL_SIZES, Input, InputGroup } from "@cjlapao/ui-kit";
...
`,K=()=>e.jsxs("div",{className:"flex w-full max-w-sm flex-col gap-3",children:[e.jsxs(o,{leadingAddon:"Amount",children:[e.jsx(t,{type:"number",placeholder:"0.00"}),e.jsxs(v,{"aria-label":"Currency",unstyled:!0,children:[e.jsx("option",{children:"USD"}),e.jsx("option",{children:"EUR"}),e.jsx("option",{children:"GBP"})]})]}),e.jsxs(o,{leadingAddon:"Search",children:[e.jsx(t,{placeholder:"Find a resource"}),e.jsx(S,{size:"md",variant:"solid",color:"blue",children:"Go"})]})]}),Q=`import { Button, Input, InputGroup, Select } from "@cjlapao/ui-kit";
