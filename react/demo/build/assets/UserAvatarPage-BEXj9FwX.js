import{r as t,j as e,bp as s,bq as g,o as f}from"./index-p9Bv1Pn1.js";import{P as j}from"./PageHeader-DCZtzAyX.js";import{E as d}from"./ExampleCard-BS13YSEO.js";import{P as b,S as l,C as w,T as p}from"./PlaygroundPanel-BDClNSzf.js";import{C as A}from"./ControlAccordion-CydkdljU.js";import{n as k,t as z}from"./options-Bqu3_N-h.js";const S=g.map(a=>({label:a,value:a})),N=()=>{const[a,m]=t.useState("md"),[r,x]=t.useState("neutral"),[i,h]=t.useState("circle"),[o,u]=t.useState(!0),[c,v]=t.useState(!1);return e.jsx(b,{controls:e.jsxs("div",{className:"space-y-3",children:[e.jsx(A,{groups:[{id:"options",title:"Options",controls:e.jsxs(e.Fragment,{children:[e.jsx(l,{label:"Size",options:k,value:a,onChange:n=>m(n)}),e.jsx(l,{label:"Tone",options:z,value:r,onChange:n=>x(n)}),e.jsx(l,{label:"Shape",options:S,value:i,onChange:n=>h(n)}),e.jsx(w,{label:"User",children:e.jsxs("div",{className:"space-y-1.5",children:[e.jsx(p,{label:"Has a name",checked:o,onChange:u}),e.jsx(p,{label:"Has an image (broken URL)",checked:c,onChange:v})]})})]})}]}),e.jsxs("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:["Turn the image on to see the fallback: the URL is deliberately broken, so it fails and drops back to the initial. The avatar is"," ",e.jsx("code",{children:'role="img"'})," with a name in every branch — it used to be an unlabelled ",e.jsx("code",{children:"div"})," whose only ",e.jsx("code",{children:"alt"})," was on the happy path."]})]}),preview:e.jsx(s,{size:a,tone:r,shape:i,user:{name:o?"Ada Lovelace":void 0,avatarUrl:c?"https://example.invalid/missing.png":void 0}})})};function y(){return e.jsxs("div",{className:"flex flex-wrap items-end gap-4",children:[f.map(a=>e.jsxs("div",{className:"flex flex-col items-center gap-1",children:[e.jsx(s,{size:a,user:{name:"Ada"}}),e.jsx("span",{className:"text-[11px] opacity-60",children:a})]},a)),e.jsxs("div",{className:"flex flex-col items-center gap-1",children:[e.jsx(s,{size:72,user:{name:"Ada"}}),e.jsx("span",{className:"text-[11px] opacity-60",children:"72px"})]})]})}const U=`import { CONTROL_SIZES, UserAvatar } from "@cjlapao/ui-kit";
