...
`;function L(){const[t,l]=s.useState(4);return e.jsxs("div",{className:"flex flex-col items-center justify-center gap-6",children:[e.jsx(n,{value:t,allowHalf:!0,onChange:l}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(r,{variant:"outline",size:"sm",onClick:()=>l(2.5),children:"2.5"}),e.jsx(r,{variant:"outline",size:"sm",onClick:()=>l(3),children:"3"}),e.jsx(r,{variant:"outline",size:"sm",onClick:()=>l(3.5),children:"3.5"})]})]})}const M=`import { useState } from "react";
...
`;function W(){return e.jsx("div",{className:"flex justify-center",children:e.jsx(n,{stars:10,defaultValue:6})})}const G=`import { Rating } from "@cjlapao/ui-kit";
...
`;function Y(){return e.jsx("div",{className:"flex justify-center",children:e.jsx(n,{onIcon:"Praise",offIcon:"Praise",defaultValue:3})})}const q=`import { Rating } from "@cjlapao/ui-kit";
...
`;function Z(){return e.jsx("div",{className:"flex justify-center",children:e.jsx(n,{defaultValue:3,disabled:!0})})}const _=`import { Rating } from "@cjlapao/ui-kit";
