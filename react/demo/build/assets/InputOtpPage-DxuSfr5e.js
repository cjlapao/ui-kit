...
`;function U(){return e.jsxs("div",{className:"flex flex-col items-center gap-4",children:[e.jsx(t,{length:4,size:"sm"}),e.jsx(t,{length:4,size:"md"}),e.jsx(t,{length:4,size:"lg"})]})}const X=`import { InputOtp } from "@cjlapao/ui-kit";
