import{r as a,D as P,aX as c,j as e,aY as i,M as r,C as Q}from"./index-BBK6HA-D.js";import{P as Z}from"./PageHeader-BcBcU29I.js";import{E as b}from"./ExampleCard-BVwGIEPO.js";import{P as ee,C as te,a as d,S as s,T as o}from"./ControlAccordion-DallGojj.js";import{$ as ae,d as ne,t as A,p as T,e as se,j as oe,k as le,l as ie}from"./options-D-FMIizr.js";const re=["glass","liquid-glass","default"],de=[{label:"Vendor onboarding",value:"vendor"},{label:"Release pipeline",value:"release"},{label:"Empty",value:"empty"}],ce={eyebrow:"NO PIPELINE",title:"Nothing running",steps:[]},pe=()=>{const[n,p]=a.useState("vendor"),[l,O]=a.useState("outlined"),[x,R]=a.useState("neutral"),[u,L]=a.useState("blue"),[f,D]=a.useState(P),[h,V]=a.useState(P),[k,M]=a.useState("none"),[v,B]=a.useState(!1),[g,U]=a.useState(!1),[S,z]=a.useState(!0),[w,F]=a.useState(!0),[j,G]=a.useState(!0),[C,H]=a.useState(!1),[y,$]=a.useState("classic"),[I,Y]=a.useState("medium"),[N,q]=a.useState("light"),[E,K]=a.useState({}),[W,_]=a.useState(null),X={...n==="vendor"?c:n==="release"?ae:ce,...E[n]?{activeStepId:E[n]}:{},icon:S?e.jsx(Q,{icon:"Rocket",customSize:22,tone:u}):void 0},J=re.includes(l);return e.jsx(ee,{controls:e.jsx(te,{groups:[{id:"content",title:"Content",controls:e.jsx(d,{label:"Data set",children:e.jsx(r,{fullWidth:!0,size:"sm",options:de,value:n,onChange:t=>p(t)})})},{id:"core",title:"Core",controls:e.jsxs(e.Fragment,{children:[e.jsx(s,{label:"Card variant",options:ne,value:l,onChange:t=>O(t)}),e.jsx(s,{label:"Card tone",options:A,value:x,onChange:t=>R(t)}),e.jsx(s,{label:"Accent",options:A,value:u,onChange:t=>L(t)}),e.jsx(s,{label:"Corner",options:T,value:f,onChange:t=>D(t)}),e.jsx(s,{label:"Icon corner",options:T,value:h,onChange:t=>V(t)}),e.jsx(s,{label:"Padding",options:se,value:k,onChange:t=>M(t)})]})},{id:"states",title:"States",controls:e.jsxs("div",{className:"grid grid-cols-1 gap-2",children:[e.jsx(o,{label:"Loading",checked:v,onChange:B}),e.jsx(o,{label:"Interactive",checked:g,onChange:U}),e.jsx(o,{label:"Title icon",checked:S,onChange:z}),e.jsx(o,{label:"Legend",checked:w,onChange:F}),e.jsx(o,{label:"Header",checked:j,onChange:G}),e.jsx(o,{label:"Sticky rail",checked:C,onChange:H})]})},...J?[{id:"glass",title:"Glass",controls:e.jsxs(e.Fragment,{children:[e.jsx(d,{label:"Specular",children:e.jsx(r,{fullWidth:!0,size:"sm",options:oe,value:y,onChange:t=>$(t)})}),e.jsx(d,{label:"Vibrancy",children:e.jsx(r,{fullWidth:!0,size:"sm",options:le,value:I,onChange:t=>Y(t)})}),e.jsx(d,{label:"Glass opacity",children:e.jsx(r,{fullWidth:!0,size:"sm",options:ie,value:N,onChange:t=>q(t)})})]})}]:[]]}),preview:e.jsx("div",{className:"w-full",children:e.jsxs("div",{className:"w-full rounded-lg bg-gradient-to-br from-indigo-100 via-neutral-50 to-rose-100 p-4 dark:from-slate-900 dark:via-neutral-950 dark:to-indigo-950",children:[e.jsx(i,{data:X,loading:v,accentColor:u,variant:l,cardTone:x,corner:f,iconCorner:h,padding:k,glassOpacity:N,vibrancy:I,specularMode:y,showLegend:w,showHeader:j,stickyRail:C,onStepSelect:g?t=>{K(m=>({...m,[n]:t})),_(`step "${t}" selected`)}:void 0,onSubStepSelect:g?(t,m)=>_(`sub-step "${m}" of "${t}"`):void 0}),W&&e.jsx("p",{className:"mt-2 text-xs text-neutral-500 dark:text-neutral-400",children:W})]})})})};function ue(){const[n,p]=a.useState(c.activeStepId),l={...c,activeStepId:n};return e.jsx("div",{className:"w-full",children:e.jsx(i,{data:l,onStepSelect:p})})}const ge=`import { useState } from "react";
...
`,fe={eyebrow:"NO PIPELINE",title:"Nothing running",steps:[]};function he(){return e.jsxs("div",{className:"grid w-full gap-4 xl:grid-cols-2",children:[e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx(i,{data:fe}),e.jsx("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:"Empty steps — the built-in placeholder."})]}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx(i,{data:c,loading:!0}),e.jsx("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:"Loading — the rail and cards swap for skeletons."})]})]})}const ke=`import { sampleWorkflow, WorkflowTracker } from "@cjlapao/ui-kit";
import type { WorkflowData } from "@cjlapao/ui-kit";
