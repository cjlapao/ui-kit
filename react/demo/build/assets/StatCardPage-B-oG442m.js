import{j as e,b4 as a,b5 as r,b6 as s,b7 as o}from"./index-BBK6HA-D.js";import{P as i}from"./PageHeader-BcBcU29I.js";import{E as n}from"./ExampleCard-BVwGIEPO.js";import{P as d,C as c}from"./ControlAccordion-DallGojj.js";import{u}from"./StatBaseControls-dNhOHaEE.js";import"./options-D-FMIizr.js";function p(){return e.jsxs("div",{className:"grid w-full gap-4 sm:grid-cols-2 lg:grid-cols-4",children:[e.jsx(a,{label:"Inherited",value:"1.42M",size:"md"}),e.jsx(a,{label:"Bigger value",value:"1.42M",valueSize:"xl",labelSize:"xs"}),e.jsx(a,{label:"Toned value",value:"1.42M",valueTone:"emerald"}),e.jsx(a,{label:"Both toned",value:"1.42M",labelTone:"sky",valueTone:"violet"})]})}const h=`import { StatCard } from "@cjlapao/ui-kit";
...
`;function m(){return e.jsxs("div",{className:"grid w-full gap-4 sm:grid-cols-2 lg:grid-cols-4",children:[r.map(t=>e.jsx(a,{label:t,value:"1.42M",icon:"Database",subtitle:"loading",loading:!0,loaderType:t,progress:40},t)),e.jsx(a,{label:"Failed",value:"—",icon:"Database",error:{message:"Registry unreachable",onRetry:()=>{}}})]})}const b=`import { StatCard, STAT_CARD_LOADERS } from "@cjlapao/ui-kit";
