...
import type { ButtonVariant, ButtonSize } from "../Button.vue";
import type { ThemeColor } from "../../theme/Theme";
import type { PanelVariant, PanelPadding, PanelCorner } from "../Panel.vue";
...
export interface TimelinePanelItem {
   ...
   */
  isRoot?: boolean;
  /** Inline action buttons rendered on the right side. Pass a `VNodeChild` for fully custom content, or a `TimelinePanelAction[]` for the built-in button layout. */
  actions?: TimelinePanelAction[] | VNodeChild;
...
export interface TimelinePanelProps {
  ...
  title?: VNodeChild;
  /** Optional content rendered at the right of the header. Pass a `VNodeChild` for fully custom content, or a `TimelinePanelHeaderAction` for the built-in button layout. */
  headerAction?: TimelinePanelHeaderAction | VNodeChild;
  /** Timeline items */
