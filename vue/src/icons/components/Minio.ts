...
// Source: react/src/icons/components/Minio.tsx
import { defineComponent, h } from "vue";

export const Minio = defineComponent({
  name: "Minio",
  setup() {
    return () =>
      h("svg", {
