...
// Source: react/src/icons/components/Revoke.tsx
import { defineComponent, h } from "vue";

export const Revoke = defineComponent({
  name: "Revoke",
  setup() {
    return () =>
      h("svg", {
