...
// Source: react/src/icons/components/RedHat.tsx
import { defineComponent, h } from "vue";

export const RedHat = defineComponent({
  name: "RedHat",
  setup() {
    return () =>
      h("svg", {
