...
// Source: react/src/icons/components/Idea.tsx
import { defineComponent, h } from "vue";

export const Idea = defineComponent({
  name: "Idea",
  setup() {
    return () =>
      h("svg", {
