...
// Source: react/src/icons/components/ReverseProxyHeadersRequest.tsx
import { defineComponent, h } from "vue";

export const ReverseProxyHeadersRequest = defineComponent({
  name: "ReverseProxyHeadersRequest",
  setup() {
    return () =>
      h("svg", {
        "width": "16px",
