...
// Source: react/src/icons/components/VirtualMachine.tsx
import { defineComponent, h } from "vue";

export const VirtualMachine = defineComponent({
  name: "VirtualMachine",
  setup() {
    return () =>
      h("svg", {
